...
<html lang="en"> 
<head>
<title>Giveaways | Chillonline</title>
<link rel="shortcut icon" type="image/png" href="chilli.png"/>
<script src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
<meta charset="utf-8" /> 
<meta name="keywords" content="Chillonline, free videos, free movies, free music, free TV shows, free TV series, free TV channels, free radio channels, free games, free online games" />
<meta name="description" content="Explore and share free movies, videos, music, TV shows, TV channels, radio channels, and
      games with friends, family, and the world around you." />
  ...
  <header>
    ...
    <div class="store">
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="movies/comedy/giveaways.jsp" >&nbsp; Comedy</a></li>
          ...
          <div class=""> &nbsp; &nbsp; &nbsp; &nbsp; <input type="checkbox" class="search-program"> Asia</div>
          <div class=""> &nbsp; &nbsp; &nbsp; &nbsp; <input type="checkbox" class="search-program"> Europe</div>
          <div class=""> &nbsp; &nbsp; &nbsp; &nbsp; <input type="checkbox" class="search-program" checked> North America</div>
          <div class=""> &nbsp; &nbsp; &nbsp; &nbsp; <input type="checkbox" class="search-program"> South America</div>
        ...
        <div class="store-content">
            ...
            <form id="selector_form" method="post" action="checkout.jsp">
  ...
  ga('send', 'pageview');
            ...
            <div class="product">
                    ...
                    <div class="poster">
                        ...
                        <a href="javascript:transferTVChannelByID(<%= channels.getTVChannel(count).getTvChannelID() %>);" id="product-anchor">
                            <img src="<%= channels.getTVChannel(count).getTvChannelPoster() %>" alt="agri" id="product-poster2" title="Play Trailer">
                        </a>
                        
                    </div>
                   
                <div class="definition"><a class="definition-style"><%= channels.getTVChannel(count).getTvChannelName() %></a></div>
                <div class="distributor"><%= channels.getTVChannel(count).getDistributor() %></div>
                <div class="loves-n-seeds"><a class="loves-style"><%= channels.getTVChannel(count).getLocality() %></a></div>
                <div class="commentaries"><a class="definition-style"><%= channels.getTVChannel(count).getRentalPrice() %></a></div>
                <div class="loves-n-seeds"></div>
            </div>
            ...
            <div class="product">
                    ...
                    <div class="poster">
                        ...
                        <a href="javascript:transferRadioChannelByID(<%= rchannels.getRadioChannel(count).getRadioChannelID() %>);" id="product-anchor">
                            <img src="<%= rchannels.getRadioChannel(count).getRadioChannelPoster() %>" alt="agri" id="product-poster2" title="Play Trailer">
                        </a>
                        
                    </div>
                   
                <div class="definition"><a class="definition-style"><%= rchannels.getRadioChannel(count).getRadioChannelName() %></a></div>
                <div class="distributor"><%= rchannels.getRadioChannel(count).getDistributor() %></div>
                <div class="loves-n-seeds"><a class="loves-style"><%= rchannels.getRadioChannel(count).getLocality() %></a></div>
                <div class="commentaries"><a class="definition-style"><%= rchannels.getRadioChannel(count).getRentalPrice() %></a></div>
                <div class="loves-n-seeds"></div>
            </div>
            ...
            <div class="product">
                        <div class="poster">
                            ...
                            <a href="javascript:transferGameByID(<%= games.getGame(count).getGameID() %>);" id="product-anchor">
                                <img src="<%= games.getGame(count).getGamePoster() %>" alt="agri" id="product-poster2" title="Play Trailer">
                            </a>
                        
                    </div>
                <div class="definition"><a class="definition-style"><%= games.getGame(count).getGameName() %></a></div>
                <div class="distributor"><%= games.getGame(count).getDistributor() %></div>
                <div class="loves-n-seeds"><a class="loves-style"><%= games.getGame(count).getLocality() %></a></div>
                <div class="commentaries"><a class="definition-style"><%= games.getGame(count).getPurchasePrice() %></a></div>
            </div>
