<%-- 
    ...
    Created on : 29-Aug-2017, 2:35:44 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Radio Channel Distribution | Chillonline&trade;</title>
  ...
  <header>
      ...
      <div class="pre-subheader">
          ...
          <nav class="stream-navigation">
                ...
                <ul>
                    <li><a class="a" href="../games/distribution.jsp" >Games</a></li>
                    <li><a class="a" href="../sounds/distribution.jsp" id="subpage">Radio</a></li>
                    <li><a class="a" href="../channels/distribution.jsp" >TV</a></li>
                    <li><a class="a" href="../music/distribution.jsp" >Music</a></li>
                    <li><a class="a" href="../series/distribution.jsp" >TV Series</a></li>
                    <li><a class="a" href="../movies/distribution.jsp" >Movies</a></li>
                    <li><a class="a" href="../videos/distribution.jsp" >Videos</a></li>
                </ul>
      ...
      <div class="subheader">
		...
		<div class="flexsearch--wrapper">
				...
				<div class="flexsearch--input-wrapper">
					<input class="flexsearch--input" type="search" name="search-name" placeholder="Distribution Search">
				</div>
              ...
              <select name="department" class="search-dept">
                ...
                <option value="radio">in Radio</option>
       ...
       <div class="announcement">Add a new content or search and edit a previous distribution. 
        ...
        <div class="checkout-content">
            ...
            <div class="blackscreen">
                    ...
                    <div id="big-headphones-division">
                        <i class="fa fa-cloud-upload" style="font-size:255px;color:#ccc"></i>
                    </div>
            ...
            <div id="program-description-area"></div>
        ...
        <div class="checkout-information">
            ...
            <div class="cb-div">
                ...
                <form id="feed-form" name="feed-form" method="post" action="../signin.jsp">
                    ...
                    <input type='button' class="checkout-button" value="Feed Content to My Account" />
                </form>
