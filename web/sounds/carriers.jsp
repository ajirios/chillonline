...
<html lang="en"> 
<head>
<title>Radio Packages | Chillonline</title>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../sounds/carriers.jsp" class="current" >&nbsp; Radio channels</a></li>
        ...
        <div class="browsed">    
            ...
            <div class="carrier-container">
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="https://s3.ca-central-1.amazonaws.com/pegbucket/radio/posters/hot.jpg" alt="poster"></div>
...
public RadioChannels()
{
    ...
    try
    {
        ...
        channelsStatement = channelsConnection.prepareStatement("SELECT radioID, radioPoster, radioName, distributor, rentalPrice, locality FROM radio WHERE radioID<31");
    }
    ...
    return channelSet;
                ...
                <%
                    ...
                    <%
                        ...
                        for (count = 0; (count < 30) && (rchannelsSet.next() == true); count++) {
                        %>
                    
                        <div id="product-container2"><img class="program-poster2" src="<%= rchannelsSet.getString("radioPoster") %>" alt="poster"></div>
