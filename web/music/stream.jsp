...
<meta name="description" content="Explore and share music with friends, family, and the world around you." />
      ...
      <div class="pre-subheader">
          ...
          <nav class="stream-navigation">
                ...
                <ul>
                    ...
                    <li><a class="a" href="../music/stream.jsp" id="subpage" >Music</a></li>
                    <li><a class="a" href="../series/stream.jsp" >TV Series</a></li>
        ...
        <div class="checkout-content">
            ...
            <div class="lower-interactions">
                ...
                %>
                    ...
                    <i class="fa fa-film" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= music.getMusic().getSongList().getSong(episodeNumber - 1).getNumberOfPodcastFeeds() %> feeds</span>  &nbsp; &nbsp; 
                    <i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= music.getMusic().getSongList().getSong(episodeNumber - 1).getNumberOfPodcastPeppers() %> peppers</span>  &nbsp; &nbsp; 
                    <i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= music.getMusic().getSongList().getSong(episodeNumber - 1).getNumberOfPodcastShares() %> shares</span>
