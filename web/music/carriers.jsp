...
<html lang="en"> 
<head>
<title>Music Packages | Chillonline</title>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../music/carriers.jsp" class="current" >&nbsp; Music</a></li>
        ...
        <div class="browsed">    
            ...
            <div class="carrier-container">
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="../music/posters/2020.jpg" alt="poster"></div>
...
public Music()
{
    ...
    try
    {
        ...
        musicStatement = musicConnection.prepareStatement("SELECT musicID, musicPoster, musicName, distributor, purchasePrice, locality FROM music WHERE musicID<31");
    }
    ...
    return musicSet;
                ...
                <%
                    ...
                    <%
                        ...
                        for (count = 0; (count < 30) && (musicSet.next() == true); count++) {
                        %>
                    
                        <div id="product-container2"><img class="program-poster2" src="<%= musicSet.getString("musicPoster") %>" alt="poster"></div>
