        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="../../movies/horror/carriers.jsp" class="current" >&nbsp; Horror</a></li>
...
public Movies()
{
    ...
    try
    {
        ...
        moviesStatement = moviesConnection.prepareStatement("SELECT movieID, moviePoster, movieName, distributor, rentalPrice, locality FROM movies WHERE movieID<31");
    }
            ...
            <div class="carrier-container">
                ...
                <div class="plan-container">
                    ...
                    <%
                        ...
                        for (count = 0; (count < 30) && (moviesSet.next() == true); count++) {
                        %>
                    
                        <div id="product-container"><img class="program-poster" src="<%= moviesSet.getString("moviePoster") %>" alt="poster"></div>
