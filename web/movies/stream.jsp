...
<meta name="description" content="Explore and share movies with friends, family, and the world around you." />
      ...
      <div class="pre-subheader">
          ...
          <nav class="stream-navigation">
                ...
                <ul>
                    ...
                    <li><a class="a" href="../movies/stream.jsp" id="subpage" >Movies</a></li>
       ...
       <div class="announcement">Want to connect with the online community? Just sign in and relax. 
           ...
           <button class="button2" onclick="window.location.href='../index.jsp'">Register</button>.
            ...
            <div id="page-request-form-div">
                ...
                <form id="page-request-form" method="post" action="stream.jsp">
        ...
        <div class="checkout-content">
            ...
            <div class="lower-interactions">
                ...
                <div class="lower-interactions-right">
                    <i class="fa fa-film" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= movies.getNumberOfPodcastFeeds() %> feeds</span>  &nbsp; &nbsp; 
                    <i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= movies.getNumberOfPodcastPeppers() %> peppers</span>  &nbsp; &nbsp; 
                    <i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= movies.getNumberOfPodcastShares() %> shares</span>
                </div>
