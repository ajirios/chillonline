...
<%@page import="checkout.MovieCheckout" %>
        ...
        <%
            ...
            { 
                ...
                
                {
                    ...
                    MovieCheckout instantiator = new MovieCheckout();
            ...
            <%
                    ...
                    MovieCheckout movies = new MovieCheckout(someID);   
    ...
    <div class="store">
        ...
        <div class="checkout-content">
            ...
            <div class="blackscreen">
                ...
                <video id="movieteaser" autoplay>
                            <source src="<%= movies.getTeaser() %>" type="video/mp4">
            ...
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-name-area">
                        ...
                        <div id="distributor-name"><%= movies.getProgramDistributorName() %></div>
                    </div>
        ...
        <div class="checkout-information">
            ...
            <div class="product-id">
                <span class="definition-style"><%= movies.getProgramName() %></span>
            </div>
            <div class="checkout-space"></div>
            ...
            <div class="cb-div">
                    ...
                    <input type='button' class="checkout-button" onclick="transferMovieByID(<%= movies.getProgramID() %>, 'rental')" value="Rent <%= movies.getRentalPrice() + " / mo." %> " />
             
            </div>
            <div class="checkout-space"></div>
            <div class="cb-div">

                   <button class="checkout-button" onclick="transferMovieByID(<%= movies.getProgramID() %>, 'purchase')">Buy <%= movies.getPurchasePrice() %></button>
