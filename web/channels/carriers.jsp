...
<html lang="en"> 
<head>
<title>TV packages | Chillonline</title>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../channels/carriers.jsp" class="current" >&nbsp; TV channels</a></li>
        ...
        <div class="browsed">    
            ...
            <div class="carrier-container">
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="https://s3.ca-central-1.amazonaws.com/pegbucket/tv/posters/cn.png" alt="poster"></div>
...
public TVChannels()
{
    ...
    try
    {
        ...
        channelsStatement = channelsConnection.prepareStatement("SELECT channelID, channelPoster, channelName, rentalPrice, locality FROM tv WHERE channelID<31");
    }
    ...
    return channelSet;
                ...
                <%
                    ...
                    <%
                        ...
                        for (count = 0; (count < 30) && (channelsSet.next() == true); count++) {
                        %>
                    
                        <div id="product-container2"><img class="program-poster2" src="<%= channelsSet.getString("channelPoster") %>" alt="poster"></div>
