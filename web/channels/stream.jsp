...
<meta name="description" content="Explore and share TV channels with friends, family, and the world around you." />
      ...
      <div class="pre-subheader">
          ...
          <nav class="stream-navigation">
                ...
                <ul>
                    ...
                    <li><a class="a" href="../channels/stream.jsp" id="subpage" >TV</a></li>
      ...
      <div class="subheader">
		...
		<div class="flexsearch--wrapper">
				...
				<div class="flexsearch--input-wrapper">
					<input class="flexsearch--input" type="search" placeholder="Content Search">
				</div>
       ...
       <div class="announcement">Want to connect with the online community? Just sign in and relax. 
           ...
           <button class="button2" onclick="window.location.href='../register.jsp'">Register</button>.
       </div> 
    ...
    { // IE < 9
        ...
        <div class="checkout-information">
            ...
            <div class="cb-div">
                    ...
                    <input type='button' class="checkout-button" onclick="" value="Feed Content to My Account" />
