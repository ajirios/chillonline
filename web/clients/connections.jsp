...
<html lang="en"> 
<head>
<title>Connections | Chillonline</title>
...
<body>
    ...
    <%
        ...
        <%
            ...
            if (request.getParameter("connection-id-request") != null)
                
            {
                accountNumber = Long.parseLong(request.getParameter("connection-id-request"));
            ...
            ConnectionSearch connectionExistsSearch = new ConnectionSearch(sessionAccountNumber, client.getClientID());
            boolean connectionExists = connectionExistsSearch.search();
...

{
    ...
    {
        document.forms["connect-request-form"].submit(); 
    }
    
    function submitDisconnectForm()
    
    {
        document.forms["disconnect-request-form"].submit(); 
    }
    ...
    <div class="right">
        ...
        <%
            ...
            <div id="connect"><button class="button2" onclick="submitConnectForm()">Connect</button></div>
        ...
        <%
            ...
            <div id="connect"><button class="button2" onclick="submitDisconnectForm()">Disconnect</button></div>
    ...
    <div class="sept2">
        ...
        <div id="container">
            ...
            <div id="posts">
                ...
                <form hidden id="connect-request-form" method="post" action="../ConnectionCreateServlet">
                    
                    <input type="text" id="connect-request-account-number" name="connect-request-account-number" value="<%= accountNumber %>" />
                    <input type="text" id="connect-request-client-id" name="connect-request-client-id" value="<%= sessionClient.getClientID() %>" />
                    <input type="submit" />
                    
                </form>
                
                
                <form hidden id="disconnect-request-form" method="post" action="../ConnectionDeleteServlet">
                    
                    <input type="text" id="disconnect-request-account-number" name="disconnect-request-account-number" value="<%= sessionAccountNumber %>" />
                    <input type="text" id="disconnect-request-client-id" name="disconnect-request-client-id" value="<%= client.getClientID() %>" />
                    <input type="text" id="disconnectee-request-account-number" name="disconnectee-request-account-number" value="<%= accountNumber %>" />
                    <input type="text" id="disconnectee-request-client-id" name="disconnectee-request-client-id" value="<%= sessionClient.getClientID() %>" />
                    <input type="submit" />
                ...
                <div class="connections-posts-label">Friends<hr></div>
