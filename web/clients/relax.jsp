<%-- 
    Document   : relax
    Created on : 8-Oct-2017, 12:06:46 AM
    Author     : El Jefe
--%>
          ...
          <a href=""><img class="bol" src="../chillon.png" alt="bol"></a>
            ...
            <nav>
                ...
                <ul>
                    ...
                    -->
                    <li><a class="a" href="../clients/jobs.jsp" >Job Boards</a></li>
                    <li><a class="a" href="../clients/boards.jsp" >Course Boards</a></li>
                    <li><a class="a" href="../clients/relax.jsp">Leisure Boards</a></li>
...
<script type="text/javascript">
    ...
    
    {
        ...
        <div class="headtext"><p>Relieve your work stress with relaxation boards.</p></div>
