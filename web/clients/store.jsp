<%-- 
    Document   : store
    Created on : 26-Sep-2016, 2:10:18 PM
    Author     : El Jefe
--%>
...
<body>
  ...
  <header>
    ...
    <div class="store">
        ...
        <form hidden id="movie_form" method="post" action="../clients/movies/checkout.jsp">
        ...
        <form hidden id="series_form" method="post" action="../clients/series/checkout.jsp">
                
                <input type='number' id="packageID" name="packageID">
                <input type='text' id="department" name="department">
                <input type="submit" id="submit-form-button2">
                
            </form>
        
        <form hidden id="music_form" method="post" action="../clients/music/checkout.jsp">
                
                <input type='number' id="packageID" name="packageID">
                <input type='text' id="department" name="department">
                <input type="submit" id="submit-form-button3">
                
            </form>
        
        <form hidden id="tv_form" method="post" action="../clients/channels/checkout.jsp">
        ...
        <form hidden id="radio_form" method="post" action="../clients/sounds/checkout.jsp">
        ...
        <form hidden id="game_form" method="post" action="../clients/games/checkout.jsp">
