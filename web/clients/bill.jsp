   ...
   <!-- <div class="store"> -->
        ...
        <div class="bill">
            ...
            <div class="poster-area">
                ...
                <img src='../suitelife.jpeg' alt='order' class="poster" >
            ...
            <div class="subtotal-area">
                ...
                <div class=""></div>
                <div class=""></div>
                <div class="product-id"><span class="">The Suite Life On Deck Season 1</span></div>
                <div class="distributor"><span class="">Disney</span></div>
                <div class="subtotal"><div class="charge">Subtotal:</div><div class="toll">USD$24.99</div></div>
                <div class="gst"><div class="charge">GST/HST:</div><div class="toll">USD$2.00</div></div>
                <div class="rst"><div class="charge">RST:</div><div class="toll">USD$1.25</div></div>
                <div class="total"><div class="charge">Total:</div><div class="toll">USD$28.24</div></div>
                <div class="rst"><div class="toll">Available to you for 1 month.</div></div>
                <div class=""></div>
            ...
            <div class="proceed-area">
                ...
                <form method="post" action="../clients/receipt.jsp" class="">
                    ...
                    <br>
                    <div class="rst"><div class="toll">By clicking on the button above or below, I hereby agree that this package will be added to the specified account(s) 
                        in accordance with the Terms of Service.</div></div><br><br><br><br><br>
                    
                    <button class="checkout-button">Post to My Account</button><br><br>
