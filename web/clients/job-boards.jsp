<%-- 
    Document   : job
    Created on : 14-Oct-2017, 11:33:47 AM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Job Boards | Chillonline</title>
      ...
      <div class="subheader">
		...
		<div class="flexsearch--wrapper">
				...
				<div class="flexsearch--input-wrapper">
					<input class="flexsearch--input" type="search" name="search-name" placeholder="Search board name by job field">
				</div>
...
<script type="text/javascript">
    ...
    
    {
        ...
        <div class="headtext"><p>Create job boards to keep track of all found job postings around you.</p></div>
        ...
        <div class="myboard">
            <div class="board-type">My job boards</div>
            <div class="board-add">
        ...
        <div id="my-boards-container">
                    ...
                    <%
                        ...
                        JobBoardList boards = new JobBoardList(sessionAccountNumber);
