...
<%@page import="checkout.MusicCheckout" %>
<%@page import="log.*" %>
        ...
        <%
            ...
            { 
                ...
                
                {
                    ...
                    MusicCheckout instantiator = new MusicCheckout();
            ...
            <%
                    ...
                    MusicCheckout music = new MusicCheckout(someID);   
            ...
            <div id="episode-order-request-form-div" hidden>
                ...
                <form id="episode-order-request-form" method="post" action="checkout.jsp" hidden>
                    ...
                    <input type="text" id="department2" name="department" value="music" />
    ...
    <div class="store">
        ...
        <div class="checkout-processor">
            ...
            <div class="episodes">
             ...
             <a class="clickable-text" href="javascript:transferSongByOrder(<%= music.getMusic().getSongList().getSong(count).getSongOrder() %>, <%= someID %>);" ><div class="episode">
            ...
            <div class="upper-interactions">
                ...
                %>
                    ...
                    <div class="distributor-name-area">
                        ...
                        <div id="distributor-name"><%= music.getProgramDistributorName() %></div>
                    </div>
        ...
        <div class="checkout-information">
            ...
            <div class="product-id">
                <span class="definition-style"><%= music.getProgramName() %></span>
            </div>
            <div class="checkout-space"></div>
            ...
            <div id="movie-transact">
                ...
                <div class="cb-div">
                       ...
                       <button class="checkout-button" onclick="transferMusicByID(<%= music.getProgramID() %>, 'purchase')">Buy <%= music.getPurchasePrice() %></button>
