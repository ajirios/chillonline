<%-- 
    Document   : index
    Created on : 15-Oct-2016, 7:59:04 PM
    Author     : El Jefe
--%>
    ...
    <script>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../../clients/music/index.jsp" class="current" >&nbsp; Music</a></li>
        ...
        <div class="browsed">    
            ...
            <%
                    ...
                    MusicList music = new MusicList(pageNumber);
            ...
            <div hidden id="page-request-form-div">
                ...
                <form id="page-request-form" method="post" action="index.jsp">
                    ...
                    <input type="text" id="final-page-number" name="final-page-number" value="<%= music.getFinalPageNumber() %>" />
                    ...
                    <%
                        ...
                        for (count = 0; (count < 18) && (music.getMusic(count) != null); count++) {
                        %>
            ...
            <div class="product">
                ...
                <div class="loves-n-seeds"><a href="" class="loves-style"><%= music.getMusic(count).getLocality() %></a></div>
                ...
                <div class="loves-n-seeds"></div>
                    ...
                    <div class="hottest"><div class="browsing">
                            ...
                            <div class="browsing-place"><%= music.getCurrentPageNumber() %> of <%= music.getFinalPageNumber() %></div>
