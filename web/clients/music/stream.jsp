...
<%@page import="song.SongRetrieve"%>
<%@page import="client.ClientRetrieve"%>
<%@page import="java.sql.*" %>
<%@page import="java.util.Date" %>
<%@page import="stream.*" %>
<%@page import="account.music.*" %>
<%@page import="song.peppers.SongPepperToggleServlet" %>
      ...
      <div class="pre-subheader">
          ...
          <nav class="stream-navigation">
                ...
                <ul>
                    ...
                    <li><a class="a" href="../../clients/channels/stream.jsp" >TV</a></li>
                    <li><a class="a" href="../../clients/music/stream.jsp" id="subpage" >Music</a></li>
      ...
      <%
                ...
                
                {
...

                    {
                        ...
                        MusicStream instantiator = new MusicStream();
    ...
    { // IE < 9
        ...
        
        {
            ...
            <%
                    ...
                    MusicStream music = new MusicStream(pageNumber);
                    
                    if (music.getMusic().getSongList().getSize() > 0)
                    
                    {
                        SongRetrieve songRetrieve = new SongRetrieve(pageNumber, episodeNumber);
                        songID = songRetrieve.getSongID();
                    }
            ...
            <div id="episode-order-request-form-div" hidden>
                ...
                <form id="song-pepper-submit-form" method="post" action="../../SongPepperToggleServlet" hidden>
                    
                    <input type="text" id="music-pepper-id" name="music-pepper-id" value="<%= pageNumber %>" />
                    <input type="text" id="song-pepper-id" name="song-pepper-id" value="<%= songID %>" />
    ...
    <div class="store">
        ...
        <div class="checkout-processor">
            ...
            <div class="episodes">
                ...
                <div class="mini-blackscreen">
                        ...
                        <div id="headphones-division">
                            <i class="fa fa-music" style="font-size:70px;color:#ccc"></i>
                        </div>
            ...
            else if (music.getMusic().getSongList().getSize() > 0) {
                
                for (count = episodeNumber - 1; (count < episodeNumber + 11) && (count < music.getMusic().getSongList().getSize()); count++)
             ...
             <a class="clickable-text" href="javascript:transferSongByOrder(<%= music.getMusic().getSongList().getSong(count).getSongOrder() %>, <%= pageNumber %>);" ><div class="episode">
                    ...
                    <audio id="podcast-side">
                            <source src="<%= music.getMusic().getSongList().getSong(count).getPodcast() %>" type="audio/mpeg">
                            Your browser does not support HTML5 audio.
                          </audio>
                    </div>
                    <div class="title"><%= music.getMusic().getSongList().getSong(count).getSongName() %></div>
                  <div class="views"><%= music.getProgramDistributorName() %></div>
                  <div class="views"><%= music.getMusic().getSongList().getSong(count).getNumberOfPodcastFeeds() %> feeds</div>
                </div></a>
        ...
        <div class="checkout-content">
            ...
            <div class="blackscreen">
                ...
                %>
                    ...
                    <audio id="music-podcast" autoplay>
                        <source src="<%= music.getMusic().getSongList().getSong(episodeNumber - 1).getPodcast() %>" type="audio/mpeg">
                            Your browser does not support HTML5 audio.
                    </audio>
            ...
            <div class="upper-interactions">
                ...
                <div class="distributor-logo-area">
                                    ...
                                    if (music.getProgramDistributorPicture() != null) {

                                        %>
                        
                        <img id="distributor-logo" src="<%= music.getProgramDistributorPicture() %>" alt="distributor-logo" />
                    ...
                    <div class="distributor-name-area">
                        <div id="program-name"><%= music.getMusic().getSongList().getSong(episodeNumber - 1).getSongName() %></div>
                        <div id="distributor-name">Distributed by <%= music.getProgramDistributorName() %> | &COPY; <%= music.getProducer() %>, <%= music.getProductionCountry() %></div>
                    </div>
            ...
            <div class="lower-interactions">
                ...
                %>
                    ...
                    <a class="clickable-text" href="javascript:submitSongPepperSubmitForm();" title='Pep up this video.' >
                        <span id="number-of-peppers"><%= music.getMusic().getSongList().getSong(episodeNumber - 1).getNumberOfPodcastPeppers() %> &nbsp; </span><i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pep</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayPostControls();" title='Comment on this video.' >
                        <span id="number-of-peppers">0 &nbsp; </span><i class="fa fa-comment" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Comment</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:feedToAccount(<%= pageNumber %>, <%= accountNumber %>);" title='Feed this video to your account.' >
                        <span id="number-of-peppers"><%= music.getMusic().getSongList().getSong(episodeNumber - 1).getNumberOfPodcastFeeds() %> &nbsp; </span><i class="fa fa-film" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Feed</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayShareControls();" title='Share this video to a board.' >
                        <span id="number-of-peppers"><%= music.getMusic().getSongList().getSong(episodeNumber - 1).getNumberOfPodcastShares() %> &nbsp; </span><i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Share</span>
                    </a>
                ...
                <div id="share-controls-div">
                        ...
                        <form id="share-form" name="share-form" method="post" action="../board.jsp">
                            
                            <div class="share-interactions">

                                <div class="share-interactions-left">

                                    <textarea id="share-textarea" rows='3' cols='90' placeholder="Let your board members know what you think about this content."></textarea>
                            ...
                            <select name="department" class="share-board">
                              <option value="all">Home</option>
                              <option value="channels">Winnipeg Community</option>
                              <option value="sounds">Seun and me</option>
                              <option value="videos">Firmage and me</option>
                              <option value="movies">Sister Stokes and me</option>
                              <option value="series">Osayus board</option>
                              <option value="games">Sadie Farley girl</option>
                            </select> 
                            </div>
                            
                            <div class="share-top-right"><input type='button' class="cancel-button" onclick="closeShareControls()" value="Cancel" /></div>
                            
                            <input type="text" id="share-number" name="share-number" value="<%= pageNumber %>" hidden />
                            <input type="text" id="share-department" name="share-department" value="video" hidden /> <br><br><br>
                    ...
                    <div id="post-controls-div">         
                        ...
                        <div class="share-interactions">
                            ...
                            <div class="share-interactions-left">
                                ...
                                <textarea id="share-textarea" rows='3' cols='90' placeholder="Post something publicly about this content."></textarea>

                            </div>

                            
                        </div>
                        <div class="share-top-left"> &nbsp; <input type='button' class="cancel-button" onclick="closePostControls()" value="Cancel" /></div>
                        <div class="share-top-right"><input type='button' class="cancel-button" onclick="" value="Post" /></div>
                        <br>
            ...
            <div id="program-description-area"><%= music.getProgramDescription() %></div>
        ...
        <div class="checkout-information">
            ...
            <div class="checkout-poster">
                ...
                <img src="<%= music.getProgramPoster() %>" alt='Cover poster' class="cover-poster" />
                
                
                  
                  <div class="title"><%= music.getProgramName() %></div>
                  <div class="views"><%= music.getProgramDistributorName() %></div>
            ...
            <div class="cb-div">
                ...
                <form id="feed-form" name="feed-form" method="post" action="../../MusicFeed">
                    <input type="text" id="program-request-number" name="program-request-number" value="<%= pageNumber %>" hidden />
                    <input type="text" id="song-request-number" name="song-request-number" value="<%= songID %>" hidden />
                    ...
                    <input type='button' class="checkout-button" onclick="feedToAccount(<%= pageNumber %>, <%= accountNumber %>)" value="Feed to My Account" />
                </form>
            ...
            <%
                        ...
                        for (count = 0; (count < 6) && (music.getMusic(count) != null); count++) {
            ...
            <div class="checkout-poster">
                ...
                <a class="clickable-text" href="javascript:transferMusicByID(<%= music.getMusic(count).getMusicID() %>);" ><div class="episode">
                  
                
                
                    <img src="<%= music.getMusic(count).getMusicPoster() %>" alt='Cover poster' class="cover-poster" />
                
                
                  
                  <div class="title"><%= music.getMusic(count).getMusicName() %></div>
                  <div class="views"><%= music.getMusic(count).getDistributor() %></div>
                  <div class="views">0 feeds</div>
                    </div>
                </a>
...

{
    ...
    {
        document.getElementById("page-request-number").value = musicID;
...
function transferSongByOrder(songOrder, musicID)

{
    type = "music";
    
    if ((songOrder > 0) && (musicID > 0))
        
    {
        document.getElementById("episode-order-request-number").value = songOrder;
        document.getElementById("page-request-number2").value = musicID;
...
function submitSongPepperSubmitForm()

{
    document.getElementById("song-pepper-submit-form").submit();
}
