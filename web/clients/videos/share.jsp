<%-- 
    Document   : share
    Created on : 2-Jul-2017, 7:03:55 PM
    Author     : El Jefe
--%>
    ...
    <div class="store">                   
        ...
        <div class="checkout-information">
            ...
            <div class="cb-div">
                ...
                <form id="feed-form" name="feed-form" method="post" action="../board.jsp">
                    ...
                    <input type='button' class="checkout-button" onclick="feedToAccount()" value="Share" />
                </form>
        ...
        <div class="checkout-content">
            ...
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-logo-area">
                        ...
                        <img class="distributor-logo-area" src="../../male.jpg" alt="poster" />

                    </div>
                    <div class="distributor-name-area">
                        <div id="program-name">Jeffrey Ajiri Osauzo</div>
                        <div id="distributor-name">Saturday, June 24, 2017 at 10:52 P.M.</div>
                    </div>
            ...
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <textarea id="share-textarea" rows='3' cols='94' placeholder="Write something..."></textarea>
            ...
            <div class="blackscreen">
                    ...
                    <img id="movieteaser" src="<%= videos.getThumbnail() %>" alt="poster" />
            ...
            <div class="lower-interactions">
                ...
                <div class="lower-interactions-right">
                    ...
                    <i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pep</span>  &nbsp; &nbsp; 
                    <i class="fa fa-comment" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Comment</span>  &nbsp; &nbsp; 
                    <i class="fa fa-film" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Feed</span>  &nbsp; &nbsp; 
                    <i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Share</span>
