  ...
  <header>
    ...
    <script>
        ...
        $('body').on('contextmenu', 'video', function(e) {return false;});
          ...
          <form hidden id="video_form" method="post" action="../videos/checkout.jsp">
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../../clients/videos/giveaways.jsp" class="current" >Videos</a></li>
        ...
        <div class="browsed">    
            ...
            <%
                    ...
                    VideoList videos = new VideoList(pageNumber);
            ...
            <div hidden id="page-request-form-div">
                ...
                <form id="page-request-form" method="post" action="giveaways.jsp">
                    ...
                    <input type="text" id="final-page-number" name="final-page-number" value="<%= videos.getFinalPageNumber() %>" />
                    ...
                    <%
                        ...
                        for (count = 0; (count < 18) && (videos.getVideo(count) != null); count++) {
                        %>
            ...
            <div class="product">
                    ...
                    <div class="poster">
                        ...
                        <a href="javascript:transferVideoByID(<%= videos.getVideo(count).getVideoID() %>);" id="product-anchor">
                          
                            
                            <div class="blackscreen">
                            
                                <img id="poster-align" src="<%= videos.getVideo(count).getVideoPoster() %>" alt="poster" />
                ...
                <div class="definition"><a class="definition-style"><%= videos.getVideo(count).getVideoName() %></a></div>
                <div class="distributor"><%= videos.getVideo(count).getDistributor() %></div>
                <div class="loves-n-seeds"><a class="loves-style"><%= videos.getVideo(count).getLocality() %></a></div>
                <div class="commentaries"><a class="definition-style"><%= videos.getVideo(count).getPurchasePrice() %></a></div>
                <div class="loves-n-seeds"></div>
                    ...
                    <div class="hottest"><div class="browsing">
                            ...
                            <div class="browsing-place"><%= videos.getCurrentPageNumber() %> of <%= videos.getFinalPageNumber() %></div>
