        ...
        <div class="bill">
            ...
            <div class="poster-area">
                ...
                <div class="mini-blackscreen">
                    ...
                    <img id="podcast-side" src="<%= bill.getThumbnail() %>" class="cover-poster" alt="poster" >
            ...
            <div class="proceed-area">
                    ...
                    <button class="checkout-button" onclick="transferVideoByID(<%= bill.getArticleID() %>, '<%= transaction %>')">Post to My Account</button><br><br>
