<%-- 
    Document   : index
    Created on : 15-Oct-2016, 7:59:43 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Videos | Chillonline</title>
  ...
  <header>
    ...
    <script>
        ...
        $('body').on('contextmenu', 'video', function(e) {return false;});
          ...
          <form id="video_form" method="post" action="../videos/checkout.jsp">
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../videos/index.jsp" class="current" >&nbsp; Videos</a></li>
