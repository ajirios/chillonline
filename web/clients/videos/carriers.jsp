<%-- 
    Document   : carriers
    Created on : 20-Feb-2017, 3:53:23 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Video packages | Chillonline</title>
      ...
      <div class="subheader">
		...
		<div class="flexsearch--wrapper">
				...
				<div class="flexsearch--input-wrapper">
					<input class="flexsearch--input" type="search" placeholder="Search for packages or programs">
				</div>
    ...
    <div class="store">
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    <li><a href="../../clients/movies/carriers.jsp" >&nbsp; Movies</a></li>
                    <li class="genre"><a href="../../clients/movies/kids/carriers.jsp" >&nbsp; Kids</a></li>
                    <li class="genre"><a href="../../clients/movies/action/carriers.jsp" >&nbsp; Action</a></li>
                    <li class="genre"><a href="../../clients/movies/comedy/carriers.jsp" >&nbsp; Comedy</a></li>
                    <li class="genre"><a href="../../clients/movies/romance/carriers.jsp" >&nbsp; Romance</a></li>
                    <li class="genre"><a href="../../clients/movies/horror/carriers.jsp" >&nbsp; Horror</a></li>
                    <li class="genre"><a href="../../clients/movies/documentary/carriers.jsp" >&nbsp; Documentary</a></li>
                    <li class="genre"><a href="../../clients/movies/adventure/carriers.jsp" >&nbsp; Adventure</a></li>
                    <li><a href="../../clients/series/carriers.jsp" >&nbsp; Series</a></li>
                    <li class="genre"><a href="../../clients/series/kids/carriers.jsp" >&nbsp; Kids</a></li>
                    <li class="genre"><a href="../../clients/series/action/carriers.jsp" >&nbsp; Action</a></li>
                    <li class="genre"><a href="../../clients/series/comedy/carriers.jsp" >&nbsp; Comedy</a></li>
                    <li class="genre"><a href="../../clients/series/romance/carriers.jsp" >&nbsp; Romance</a></li>
                    <li class="genre"><a href="../../clients/series/horror/carriers.jsp" >&nbsp; Horror</a></li>
                    <li class="genre"><a href="../../clients/series/documentary/carriers.jsp" >&nbsp; Documentary</a></li>
                    <li class="genre"><a href="../../clients/series/adventure/carriers.jsp" >&nbsp; Adventure</a></li>
                    <li><a href="../../clients/videos/carriers.jsp" class="current">&nbsp; Videos</a></li>
                    <li><a href="../../clients/music/carriers.jsp" >&nbsp; Music</a></li>
                    <li><a href="../../clients/channels/carriers.jsp" >&nbsp; TV channels</a></li>
                    <li><a href="../../clients/sounds/carriers.jsp" >&nbsp; Radio channels</a></li>
                    <li><a href="../../clients/games/carriers.jsp" >&nbsp; Games</a></li>
                </ul>
        ...
        $('body').on('contextmenu', 'video', function(e) {return false;});
            ...
            <div class="carrier-container">
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="../../series/posters/smallville8.jpg" alt="poster"></div>
                    <div class="carrier-poster-info-container">
                        ...
                        <div id="carrier-name-container">
                            ...
                            <div class="carrier-name">James Carrie</div>
                        </div>
                ...
                <div class="plan-container">
                    ...
                    <%
                            ...
                            <div id="view-all">
                                <div class="carrier-toll"><span class="carrier-toll-fee">USD$8.50</span><span class="carrier-toll-month"> / mo.</span></div>
                                <div class="billing-period">*Billing periods are monthly. You can cancel anytime.</div>
                                <div class="carrier-subscribe"><button class="button-carrier">Subscribe to this carrier's streaming plan</button></div>
                            </div>
                ...
                <div class="carrier-id-container">
                    <div id="carrier-logo-container"></div>
                    <div>
                        <div id="carrier-plan-container">The Ultimate Kids Movie Collection</div>
                        <div id="carrier-name-container">James Carrie</div>
                    </div>
                    <div></div>
                </div>
                <div class="plan-container">
                ...
                <%
                    ...
                    <%
                        ...
                        <div id="product-container"><img class="program-poster" src="<%= "../../" + series.getTVSeries(count).getTvSeriesPoster() %>" alt="poster"></div>
                    ...
                    <%
                            ...
                            <div id="view-all">
                                <div class="carrier-toll"><span class="carrier-toll-fee">USD$13.50</span><span class="carrier-toll-month"> / mo.</span></div>
                                <div class="billing-period">*Billing periods are monthly. You can cancel anytime.</div>
                                <div class="carrier-subscribe"><button class="button-carrier">Subscribe to this carrier's streaming plan</button></div>
                            </div>
                ...
                <%
                    ...
                    <%
                        ...
                        <div id="product-container2"><img class="program-poster2" src="<%= "../../" + music.getMusic(count).getMusicPoster() %>" alt="poster"></div>
                ...
                <%
                    ...
                    TVChannelList channels = new TVChannelList();
                    ...
                    <%
                        ...
                        <div id="product-container2"><img class="program-poster2" src="<%= "../../" + channels.getTVChannel(count).getTvChannelPoster() %>" alt="poster"></div>
                    ...
                    <%
                            ...
                            <div id="view-all">
                                <div class="carrier-toll"><span class="carrier-toll-fee">USD$72.50</span><span class="carrier-toll-month"> / mo.</span></div>
                                <div class="billing-period">*Billing periods are monthly. You can cancel anytime.</div>
                                <div class="carrier-subscribe"><button class="button-carrier">Subscribe to this carrier's streaming plan</button></div>
                            </div>
                ...
                <%
                    ...
                    RadioChannelList rchannels = new RadioChannelList();
                    ...
                    <%
                        ...
                        <div id="product-container2"><img class="program-poster2" src="<%= "../../" + rchannels.getRadioChannel(count).getRadioChannelPoster() %>" alt="poster"></div>
                    ...
                    <%
                            ...
                            <div id="view-all">
                                <div class="carrier-toll"><span class="carrier-toll-fee">USD$69.50</span><span class="carrier-toll-month"> / mo.</span></div>
                                <div class="billing-period">*Billing periods are monthly. You can cancel anytime.</div>
                                <div class="carrier-subscribe"><button class="button-carrier">Subscribe to this carrier's streaming plan</button></div>
                            </div>
                ...
                <%
                    ...
                    <%
                        ...
                        <div id="product-container2"><img class="program-poster2" src="<%= "../../" + games.getGame(count).getGamePoster() %>" alt="poster"></div>
                    ...
                    <%
                            ...
                            <div id="view-all">
                                <div class="carrier-toll"><span class="carrier-toll-fee">USD$136.50</span><span class="carrier-toll-month"> / mo.</span></div>
                                <div class="billing-period">*Billing periods are monthly. You can cancel anytime.</div>
                                <div class="carrier-subscribe"><button class="button-carrier">Subscribe to this carrier's streaming plan</button></div>
                            </div>
