      ...
      <div class="pre-subheader">
          ...
          <nav class="stream-navigation">
                ...
                <ul>
                    ...
                    <li><a class="a" href="../../clients/videos/stream.jsp" id="subpage" >Videos</a></li>
                </ul>
    ...
    { // IE < 9
        ...
        
        {
            ...
            <div id="page-request-form-div" hidden>
                ...
                <form id="page-share-form" method="post" action="share.jsp" hidden>
                    
                    <input type="text" id="page-share-number" name="page-request-number" value="<%= pageRequestNumber %>" />
                    <input type="submit" id="page-share-number-submit" />
    ...
    <div class="store">
            ...
            <div class="lower-interactions">
                ...
                <div class="lower-interactions-right">
                    ...
                    <a class="clickable-text" href="javascript:feedToAccount(<%= pageNumber %>, <%= accountNumber %>);" title='Feed this video to your account.' >
                        <span id="number-of-peppers"><%= videos.getNumberOfPodcastFeeds() %> &nbsp; </span><i class="fa fa-film" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Feed</span>  &nbsp; &nbsp; 
                    </a>
        ...
        <div class="checkout-information">
            ...
            <div class="cb-div">
                ...
                <form id="feed-form" name="feed-form" method="post" action="../../VideoFeed">
            ...
            <%
                        ...
                        for (count = 0; (count < 12) && (videos.getVideo(count) != null); count++) {
            ...
            <div class="checkout-poster">
                ...
                <a class="clickable-text" href="javascript:transferVideoByID(<%= videos.getVideo(count).getVideoID() %>);" ><div class="episode">
                  
                    <div class="mini-blackscreen">
                <span class="side-helper">
                          
                    <img id="podcast-side" src="<%= videos.getVideo(count).getVideoPoster() %>" alt="poster" />
                           
                </span>
                    </div>
                  <div class="title"><%= videos.getVideo(count).getVideoName() %></div>
                  <div class="views"><%= videos.getVideo(count).getDistributor() %></div>
                  <div class="views"><%= videos.getVideo(count).getNumberOfPodcastFeeds() %> feeds</div>
                    </div>
                </a>
