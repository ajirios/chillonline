<%-- 
    Document   : index
    Created on : 15-Oct-2016, 7:58:24 PM
    Author     : El Jefe
--%>
    ...
    <script>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    <li><a href="../../clients/movies/index.jsp" >&nbsp; Movies</a></li>
                    <li class="genre"><a href="../../clients/movies/kids/index.jsp" >&nbsp; Kids</a></li>
                    <li class="genre"><a href="../../clients/movies/action/index.jsp" >&nbsp; Action</a></li>
                    <li class="genre"><a href="../../clients/movies/comedy/index.jsp" >&nbsp; Comedy</a></li>
                    <li class="genre"><a href="../../clients/movies/romance/index.jsp" >&nbsp; Romance</a></li>
                    <li class="genre"><a href="../../clients/movies/horror/index.jsp" >&nbsp; Horror</a></li>
                    <li class="genre"><a href="../../clients/movies/documentary/index.jsp" >&nbsp; Documentary</a></li>
                    <li class="genre"><a href="../../clients/movies/adventure/index.jsp" >&nbsp; Adventure</a></li>
                    <li><a href="../../clients/series/index.jsp" >&nbsp; Series</a></li>
                    <li class="genre"><a href="../../clients/series/kids/index.jsp" >&nbsp; Kids</a></li>
                    <li class="genre"><a href="../../clients/series/action/index.jsp" >&nbsp; Action</a></li>
                    <li class="genre"><a href="../../clients/series/comedy/index.jsp" >&nbsp; Comedy</a></li>
                    <li class="genre"><a href="../../clients/series/romance/index.jsp" >&nbsp; Romance</a></li>
                    <li class="genre"><a href="../../clients/series/horror/index.jsp" >&nbsp; Horror</a></li>
                    <li class="genre"><a href="../../clients/series/documentary/index.jsp" >&nbsp; Documentary</a></li>
                    <li class="genre"><a href="../../clients/series/adventure/index.jsp" >&nbsp; Adventure</a></li>
                    <li><a href="../../clients/videos/index.jsp" >&nbsp; Videos</a></li>
                    <li><a href="../../clients/music/index.jsp" >&nbsp; Music</a></li>
                    <li><a href="../../clients/channels/index.jsp" class="current" >&nbsp; TV channels</a></li>
                    <li><a href="../../clients/sounds/index.jsp" >&nbsp; Radio channels</a></li>
                    <li><a href="../../clients/games/index.jsp" >&nbsp; Games</a></li>
                </ul>
        ...
        <div class="browsed">    
            ...
            <%
                    ...
                    TVChannelList channels = new TVChannelList(pageNumber);
            ...
            <div hidden id="page-request-form-div">
                ...
                <form id="page-request-form" method="post" action="index.jsp">
                    
                    <input type="text" id="page-request-number" name="page-request-number" value="<%= pageRequestNumber %>" />
                    <input type="text" id="final-page-number" name="final-page-number" value="<%= channels.getFinalPageNumber() %>" />
                    ...
                    <%
                        ...
                        for (count = 0; (count < 18) && (channels.getTVChannel(count) != null); count++) {
                        %>
            ...
            <div class="product">
                ...
                <div class="loves-n-seeds"></div>
                    ...
                    <div class="hottest"><div class="browsing">
                            ...
                            <div class="browsing-place"><%= channels.getCurrentPageNumber() %> of <%= channels.getFinalPageNumber() %></div>
