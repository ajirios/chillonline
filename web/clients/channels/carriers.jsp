<%-- 
    Document   : carriers
    Created on : 20-Feb-2017, 3:52:51 PM
    Author     : El Jefe
--%>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../../clients/channels/carriers.jsp" class="current">&nbsp; TV channels</a></li>
    ...
    <script>
        ...
        $('body').on('contextmenu', 'video', function(e) {return false;});
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="../../channels/posters/family.png" alt="poster"></div>
                    <div class="carrier-poster-info-container">
                        <div id="carrier-plan-container">The Ultimate Television Channel Collection 2017</div>
