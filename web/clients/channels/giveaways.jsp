<%-- 
    Document   : giveaways
    Created on : 3-Jan-2017, 6:40:42 PM
    Author     : El Jefe
--%>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="../../clients/movies/documentary/giveaways.jsp" >Documentary</a></li>
                    ...
                    <li><a href="../../clients/channels/giveaways.jsp" class="current" >TV channels</a></li>
