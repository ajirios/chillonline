...
try
    { 
            ...
            <%
                    ...
                    Checkout checkout = new Checkout(someID, type);   
        ...
        <div class="checkout-processor">
            ...
            <div class="episodes">
                ...
                <div class="mini-blackscreen">
                          <video id="podcast-side" >
                            <source src="<%= checkout.getPodcast() + "#t=20" %>" type="video/mp4">
                            Your browser does not support HTML5 video.
                          </video>
                    </div>
                    <div class="title"><%= checkout.getPodcastName() %></div>
                  <div class="distributor-name"><%= checkout.getProgramDistributorName() %></div>
                  <div class="views"><%= checkout.getNumberOfPodcastFeeds() %> feeds</div>
                </div></a>
        ...
        <div class="checkout-content">
            ...
            <div class="blackscreen">
                <video id="movieteaser" autoplay>
                            <source src="<%= checkout.getTeaser() %>" type="video/mp4">
                            Your browser does not support HTML5 video.
                          </video>
            </div>
            <div class="checkout-space"></div>
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-name-area">
                        <div id="program-name"><%= checkout.getProgramName() %></div>
                        <div id="distributor-name"><%= checkout.getProgramDistributorName() %></div>
                    </div>
            ...
            <div class="lower-interactions">
                ...
                <div class="lower-interactions-right">
                    <i class="fa fa-film" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= checkout.getNumberOfTeaserFeeds() %> feeds</span>  &nbsp; &nbsp; 
                    <i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= checkout.getNumberOfTeaserPeppers() %> peppers</span>  &nbsp; &nbsp; 
                    <i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers"><%= checkout.getNumberOfTeaserPeppers() %> shares</span>
                </div>
                ...
                <div class="lower-interactions-left">
                    ...
                    <div id="program-description-area"><%= checkout.getProgramDescription() %></div>
        ...
        <div class="checkout-information">
            ...
            <div class="product-id">
                <span class="definition-style"><%= checkout.getProgramName() %></span>
            </div>
            <div class="checkout-space"></div>
            <div class="checkout-poster">
                ...
                <img src="<%= checkout.getProgramPoster() %>" alt='Cover poster' class="cover-poster" />
            ...
            <div class="cb-div">
                    ...
                    <input type='button' class="checkout-button" onclick="transferTVChannelByID(<%= checkout.getProgramID() %>, 'rental')" value="Rent <%= checkout.getRentalPrice() + " / mo." %> " />
