<%-- 
    Document   : series
    Created on : 17-Sep-2016, 2:05:27 AM
    Author     : El Jefe
--%>
...
<%@page import="object.board.posts.EpisodeObjectBoardPostList"%>
<%@page import="java.sql.*" %>
<%@page import="board.stream.EpisodeStream" %>
<%@page import="account.series.*" %>
<%@page import="episode.peppers.*" %>
<%@page import="episode.board.posts.*" %>
...
<script type="text/javascript">
    ...
    <%
        ...
        %>
                ...
                <form hidden id="board-id-request-form" method="post" action="series.jsp">
      ...
      <%
                ...
                
                {
...

                    {
                        ...
                        EpisodeStream instantiator = new EpisodeStream();
                            ...
                            
                        {
                            ...
                            EpisodeRequestBoardPostCreate requestPostCreate = new EpisodeRequestBoardPostCreate(pageNumber, boardID, client.getClientID(), creationTime);
            ...
            <%
                    ...
                    EpisodeStream episode = new EpisodeStream(pageNumber);
                ...
                <div id="page-request-form-div" hidden>
                    ...
                    <form id="page-request-form" method="post" action="series.jsp" hidden>
                ...
                <form id="video-pepper-submit-form" method="post" action="../EpisodePepperToggleServlet" hidden>
                    
                    <input type="text" id="episode-pepper-id" name="episode-pepper-id" value="<%= pageNumber %>" />
                    <input type="text" id="series-pepper-page-number" name="series-pepper-page-number" value="<%= episode.getSeriesID() %>" />
                    <input type="text" id="episode-pepper-account-number" name="episode-pepper-account-number" value="<%= accountNumber %>" />
                    <input type="text" id="episode-pepper-return-page" name="episode-pepper-return-page" value="clients/series.jsp" />
                    <input type="submit" />
                ...
                <form id="feed-form" name="feed-form" method="post" target="_parent" action="../SeriesFeed" hidden>
                    <input type="text" id="program-request-number" name="program-request-number" value="<%= episode.getSeriesID() %>" hidden />
                    <input type="text" id="account-request-number" name="account-request-number" value="<%= accountNumber %>" hidden />
                    <input type="text" id="episode-request-number" name="episode-request-number" value="<%= pageNumber %>" hidden />
    ...
    { // IE < 9
        ...
        <div class=""></div>
            <div class="blackscreen">
                ...
                <video id="movieteaser" autoplay>
                    <source src="<%= episode.getPodcast() %>" type="video/mp4">
            ...
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-logo-area">
                                    ...
                                    if (episode.getDistributorPicture() != null) {

                                        %>
                        
                        <img id="distributor-logo" src="<%= episode.getDistributorPicture() %>" alt="distributor-logo" />
                    ...
                    <div class="distributor-name-area">
                        <div id="program-name"><%= episode.getEpisodeName() %></div>
                        <div id="distributor-name">Distributed by <%= episode.getDistributorName() %> | &COPY; <%= episode.getProducer() %>, <%= episode.getProductionCountry() %></div>
                    </div>
            ...
            <div class="lower-interactions">
                ...
                <div class="lower-interactions-right">
                    ...
                    <a class="clickable-text" href="javascript:submitMoviePepperSubmitForm();" title='Pep up this video.' >
                        <span id="number-of-peppers"><%= episode.getNumberOfPodcastPeppers() %> &nbsp; </span><i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pep</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayShareControls();" title='Post this video.' >
                        <span id="number-of-peppers"><%= episode.getNumberOfPodcastShares() %> &nbsp; </span><i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Share</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:feedToAccount(<%= pageNumber %>, <%= accountNumber %>);" title='Feed this video to your account.' >
                        <span id="number-of-peppers"><%= episode.getNumberOfPodcastFeeds() %> &nbsp; </span><i class="fa fa-home" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Feed</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayShareControls();" title='Pin this video.' >
                        <span id="number-of-peppers"><%= episode.getNumberOfPodcastShares() %> &nbsp; </span><i class="fa fa-thumb-tack" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pin to board</span>  &nbsp; &nbsp; 
                    </a>
                ...
                <div id="share-controls-div">
                        ...
                        <form id="share-form" name="share-form" method="post" action="../EpisodeBoardPostCreateServlet">
                            ...
                            <div class="share-top-left">
                                ...
                                <input type="text" id="request-episode-id" name="request-episode-id" value="<%= pageNumber %>" hidden />
            ...
            <%
                    ...
                    EpisodeObjectBoardPostList postList = new EpisodeObjectBoardPostList(boardID);
        ...
        %>
            ...
            <div id="news-post">
                    ...
                    <div class="news-post-feedback-write-area">
                            ...
                            <div id="post-reply-button"><span><%= documentPost.getNumberOfPostComments() %> &nbsp; </span><a class="comment-link-design" href="javascript:;"><i class="material-icons" style="font-size:17px;color:#f40">question_answer</i> &nbsp; <span>Comment</span></a></div>
        ...
        %>
            ...
            <div id="join-post">
                ...
                <div class="join-post-feedback-write-area">
                        ...
                        <div id="post-reply-button"><span><%= noticePost.getNumberOfPostComments() %> &nbsp; </span><a class="comment-link-design" href="javascript:;"><i class="material-icons" style="font-size:17px;color:#f40">question_answer</i> &nbsp; <span>Comment</span></a></div>
        ...
        %>
            ...
            if (postList.getObjectBoardPost(count) instanceof EpisodeBoardPost)
                
            {
       
                    EpisodeBoardPost episodePost = (EpisodeBoardPost) postList.getObjectBoardPost(count);
            ...
            <div id="share-post">
                    ...
                    <%
                                    ...
                                    if (episodePost.getClientProfilePicture() != null) {

                                        %>


                                    <img id="commenter-pic" src="<%= episodePost.getClientProfilePicture() %>" alt="picture" />
                                    ...
                                    {
                                        if (episodePost.getClientGender().equalsIgnoreCase("female")) {
                            ...
                            conversion = new DateLineConversion(episodePost.getCreationTime());

                                        %>
                            
                        </div>
                        <div id="share-post-header-right"><b><%= episodePost.getClientName() %></b> shared <b><%= episodePost.getEpisodeName() %></b>.</div>
                    
                    </div>
                    <div id="share-poster-background">
                        
                        <img id="share-poster-background-image" src="<%= episodePost.getSeriesPoster() %>" alt="poster"/>
                    
                    </div>
                    <div id="share-post-description"><%= episodePost.getMessage() %></div>
                    <div id="share-post-feedback-read"><%= conversion.getPostTimestamp() %></div>
                    <div id="share-post-feedback-write">
                    ...
                    <div class="share-post-feedback-write-area">
                            ...
                            <div id="post-like-button"><span id="episode-board-post-peppers"><%= episodePost.getNumberOfPostPeppers() %></span> &nbsp; <a class="pep-link-design" href="javascript:registerEpisodeBoardPostPep(<%= client.getClientID() %>, <%= boardID %>, '<%= episodePost.getEpisodeID() %>', <%= episodePost.getClientID() %>, <%= episodePost.getCreationTime() %>);"><i class="fa fa-thumbs-up" style="font-size:16px;color:#f40"></i> &nbsp; <span>Pep</span></a></div>
        ...
        %>
            ...
            <%
                    ...
                    EpisodeRequestBoardPostList requestPostList = new EpisodeRequestBoardPostList(boardID);
        ...
        <div id="posts-left">
            ...
            for (count = 0; (count < requestPostList.length()) && (requestPostList.getEpisodeRequestBoardPost(count) != null); count++)
            ...
            <div id="stream-post">
                ...
                <div id="stream-post-header">
                    ...
                    <%
                                    ...
                                    if (requestPostList.getEpisodeRequestBoardPost(count).getClientProfilePicture() != null) {

                                        %>


                                    <img id="stream-request-commenter-pic" src="<%= requestPostList.getEpisodeRequestBoardPost(count).getClientProfilePicture() %>" alt="picture" />
                                    ...
                                    {
                                        if (requestPostList.getEpisodeRequestBoardPost(count).getClientGender().equalsIgnoreCase("female")) {
                            ...
                            conversion = new DateLineConversion(requestPostList.getEpisodeRequestBoardPost(count).getCreationTime());
                        ...
                        <div id="stream-post-header-right"><%= requestPostList.getEpisodeRequestBoardPost(count).getClientName() %> requested:</div>
                        
                    </div>
                    <div id="stream-post-header-bottom"><b><%= requestPostList.getEpisodeRequestBoardPost(count).getEpisodeName() %></b></div>
                
                </div>
                <div id="stream-poster-background">
                    
                    <img id="stream-poster-background-image" src="<%= requestPostList.getEpisodeRequestBoardPost(count).getSeriesPoster() %>" alt="poster"/><br><br>
                ...
                <div class="stream-post-feedback-write-area">
                        ...
                        <div id="stream-like-button"><span id="episode-request-board-post-peppers"><%= requestPostList.getEpisodeRequestBoardPost(count).getNumberOfPostPeppers() %></span> &nbsp; <a class="pep-link-design" href="javascript:registerEpisodeRequestBoardPostPep(<%= client.getClientID() %>, <%= boardID %>, '<%= requestPostList.getEpisodeRequestBoardPost(count).getEpisodeID() %>', <%= requestPostList.getEpisodeRequestBoardPost(count).getClientID() %>, <%= requestPostList.getEpisodeRequestBoardPost(count).getCreationTime() %>);"><i class="fa fa-thumbs-up" style="font-size:16px;color:#f40"></i> &nbsp; <span>Pep</span></a></div>
...
function registerEpisodeBoardPostPep(pepperClientID, boardID, episodeID, postClientID, postCreationTime)

{
    ...
    xml.onreadystatechange = function() {
            ...
            
        {
                ...
                
            {
                ...
                var numberOfPeppers = xml.responseXML.getElementsByTagName("peppers")[0].firstChild.nodeValue;
                document.getElementById("episode-board-post-peppers").innerHTML = numberOfPeppers;
    ...
    var post = "pepper-client-id=" + pepperClientID + "&post-client-id=" + postClientID + "&episode-id=" + episodeID + "&board-id=" + boardID + "&post-creation-time=" + postCreationTime;
    
    xml.open("GET", "../EpisodeBoardPostPepperCreateServlet?" + post, true);
    xml.send();
    
    
}

function registerEpisodeRequestBoardPostPep(pepperClientID, boardID, episodeID, postClientID, postCreationTime)

{
    ...
    xml.onreadystatechange = function() {
            ...
            
        {
                ...
                
            {
                ...
                var numberOfPeppers = xml.responseXML.getElementsByTagName("peppers")[0].firstChild.nodeValue;
                document.getElementById("episode-request-board-post-peppers").innerHTML = numberOfPeppers;
    ...
    xml.open("GET", "../EpisodeRequestBoardPostPepperCreateServlet?" + post, true);
    xml.send();
