<%-- 
    Document   : board-management
    Created on : 19-Jul-2017, 7:01:39 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Board Management | Chillonline</title>
...
<script type="text/javascript">
    ...
    <div class="right">
        ...
        <div id="connect"><button class="button2">Invite</button></div>
    </div>
    <div class="sept2">
