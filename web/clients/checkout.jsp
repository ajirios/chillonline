    ...
    <a href=""><img class="bol" src="../chillon.png" alt="bol"></a>
            ...
            <nav class="nav">
                ...
                <ul>
                    ...
                    <li><a class="a" href="../clients/streaming.jsp" >Stream</a></li>
    ...
    <div class="store">
        ...
        <div class="checkout-processor">
            ...
            <div class="episodes">
                ...
                <a class="clickable-text" href="javascript:alert('Hello Chillers!');" ><div class="episode">
                    ...
                    <div class="">
                          <video width="100%" >
                            <source src="../series/content/s2e10.mp4#t=11" type="video/mp4">
        ...
        <div class="checkout-content">
            ...
            <div class="">
                <video width="100%" autoplay>
                            <source src="../videos/content/suitelife.mp4" type="video/mp4">
                            Your browser does not support HTML5 video.
                          </video>
            </div>
            <div class="checkout-space"></div>
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-name-area"><span>Disney</span></div>
        ...
        <div class="checkout-information">
            ...
            <div class="product-id">
                <span class="definition-style">The Suite Life On Deck Season 1</span>
            </div>
            <div class="checkout-space"></div>
            <div class="checkout-poster">
                <img src="../suitelife.jpeg" alt='Cover poster' class="cover-poster">
            </div>
            <div class="checkout-space"></div>
            <div class="cb-div">
                <button class="checkout-button">Rent USD$3.99 </button>
            </div>
            <div class="checkout-space"></div>
            <div class="cb-div">
               <button class="checkout-button">Buy USD$24.99</button>
            </div>
            <div class=""></div>
            <div class=""></div>
