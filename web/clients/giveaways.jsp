<%-- 
    Document   : giveaways
    Created on : 3-Jan-2017, 1:55:55 PM
    Author     : El Jefe
--%>
...
<body>
  ...
  <header>
    ...
    <div class="store">
        ...
        <form id="movie_form" method="post" action="../clients/movies/checkout.jsp">
        ...
        <form id="series_form" method="post" action="../clients/series/checkout.jsp">
        ...
        <form id="music_form" method="post" action="../clients/music/checkout.jsp">
        ...
        <form id="tv_form" method="post" action="../clients/channels/checkout.jsp">
        ...
        <form id="radio_form" method="post" action="../clients/sounds/checkout.jsp">
        ...
        <form id="game_form" method="post" action="../clients/games/checkout.jsp">
            ...
            <div class="product">
                    ...
                    <div class="poster">
                        ...
                        <a href="javascript:transferMovieByID(<%= movies.getMovie(count).getMovieID() %>);" id="product-anchor">
                            <img src="<%= movies.getMovie(count).getMoviePoster() %>" alt="agri" id="product-poster2" title="<%= movies.getMovie(count).getMovieName() %>">
                        </a>
            ...
            <div class="product">
                    ...
                    <div class="poster">
                        ...
                        <a href="javascript:transferSeriesByID(<%= series.getTVSeries(count).getTvSeriesID() %>);" id="product-anchor">
                            <img src="<%= series.getTVSeries(count).getTvSeriesPoster() %>" alt="agri" id="product-poster2" title="<%= series.getTVSeries(count).getTvSeriesName() %>">
                        </a>
            ...
            <div class="product">
                    ...
                    <div class="poster">
                        ...
                        <a href="javascript:transferMusicByID(<%= music.getMusic(count).getMusicID() %>);" id="product-anchor">
                            <img src="<%= music.getMusic(count).getMusicPoster() %>" alt="agri" id="product-poster2" title="<%= music.getMusic(count).getMusicName() %>">
                        </a>
