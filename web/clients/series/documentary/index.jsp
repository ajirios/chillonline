<%-- 
    Document   : index
    Created on : 15-Oct-2016, 7:58:51 PM
    Author     : El Jefe
--%>
    ...
    <div class="store">
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="../../../clients/series/documentary/index.jsp" class="current">&nbsp; Documentary</a></li>
        ...
        <div class="browsed">    
            ...
            <%
                    ...
                    DocumentaryTVSeriesList series = new DocumentaryTVSeriesList(pageNumber);
