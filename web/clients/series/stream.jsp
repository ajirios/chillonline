...
<%@page import="episode.*" %>
<%@page import="episode.peppers.EpisodePepperToggleServlet" %>
      ...
      <div class="pre-subheader">
          ...
          <nav class="stream-navigation">
                ...
                <ul>
                    ...
                    <li><a class="a" href="../../clients/series/stream.jsp" id="subpage" >TV Series</a></li>
    ...
    { // IE < 9
        ...
        
        {
            ...
            <%
                    ...
                    {
                        EpisodeRetrieve episodeRetrieve = new EpisodeRetrieve(pageNumber, episodeNumber);
                        episodeID = episodeRetrieve.getEpisodeID();
                    }
            ...
            <div id="episode-order-request-form-div" hidden>
                ...
                <form id="episode-pepper-submit-form" method="post" action="../../EpisodePepperToggleServlet" hidden>
                    
                    <input type="text" id="episode-pepper-page-number" name="episode-pepper-page-number" value="<%= pageNumber %>" />
                    <input type="text" id="episode-pepper-id" name="episode-pepper-id" value="<%= episodeID %>" />
    ...
    <div class="store">
        ...
        <div class="checkout-content">
            ...
            <div class="lower-interactions">
                ...
                %>
                    ...
                    <a class="clickable-text" href="javascript:submitEpisodePepperSubmitForm();" title='Pep up this video.' >
                        <span id="number-of-peppers"><%= series.getTvSeries().getEpisodeList().getEpisode(episodeNumber - 1).getNumberOfPodcastPeppers() %> &nbsp; </span><i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pep</span>  &nbsp; &nbsp; 
                    </a>
                    ...
                    <a class="clickable-text" href="javascript:feedToAccount(<%= pageNumber %>, <%= accountNumber %>);" title='Feed this video to your account.' >
                        <span id="number-of-peppers"><%= series.getTvSeries().getEpisodeList().getEpisode(episodeNumber - 1).getNumberOfPodcastFeeds() %> &nbsp; </span><i class="fa fa-film" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Feed</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayShareControls();" title='Share this video to a board.' >
                        <span id="number-of-peppers"><%= series.getTvSeries().getEpisodeList().getEpisode(episodeNumber - 1).getNumberOfPodcastShares() %> &nbsp; </span><i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Share</span>
                    </a>
        ...
        <div class="checkout-information">
            ...
            <div class="cb-div">
                ...
                <form id="feed-form" name="feed-form" method="post" action="../../SeriesFeed">
                    <input type="text" id="program-request-number" name="program-request-number" value="<%= pageNumber %>" hidden />
                    <input type="text" id="episode-request-number" name="episode-request-number" value="<%= episodeID %>" hidden />
...
function submitEpisodePepperSubmitForm()

{
    document.forms["episode-pepper-submit-form"].submit();
}
