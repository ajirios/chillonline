<%-- 
    Document   : carriers
    Created on : 3-Jan-2017, 6:41:04 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Series packages | Chillonline</title>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="../../../clients/series/action/carriers.jsp" class="current">&nbsp; Action</a></li>
        ...
        $('body').on('contextmenu', 'video', function(e) {return false;});
            ...
            <%
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="../../../series/posters/smallville1.jpg" alt="poster"></div>
                    <div class="carrier-poster-info-container">
                        <div id="carrier-plan-container">The Ultimate Series Collection 2017</div>
