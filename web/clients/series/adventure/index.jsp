    ...
    <div class="store">
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="../../../clients/series/adventure/index.jsp" class="current">&nbsp; Adventure</a></li>
        ...
        <div class="browsed">    
            ...
            <%
                    ...
                    AdventureTVSeriesList series = new AdventureTVSeriesList(pageNumber);
