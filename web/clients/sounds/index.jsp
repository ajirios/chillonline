<%-- 
    Document   : index
    Created on : 15-Oct-2016, 7:59:32 PM
    Author     : El Jefe
--%>
...
<body>
  ...
  <header>
    ...
    <script>
        ...
        <form hidden id="radio_form" method="post" action="checkout.jsp">
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../../clients/sounds/index.jsp" class="current">&nbsp; Radio channels</a></li>
        ...
        <div class="browsed">    
            ...
            <%
                    ...
                    RadioChannelList channels = new RadioChannelList(pageNumber);
            ...
            <div hidden id="page-request-form-div">
                ...
                <form id="page-request-form" method="post" action="index.jsp">
                    ...
                    <%
                        ...
                        for (count = 0; (count < 18) && (channels.getRadioChannel(count) != null); count++) {
                        %>
