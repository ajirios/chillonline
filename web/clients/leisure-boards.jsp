<%-- 
    Document   : leisure-boards
    Created on : 14-Oct-2017, 12:15:14 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Leisure Boards | Chillonline</title>
...
<body>
  ...
  <header>
      ...
      <div class="subheader">
          ...
          <form class="flexsearch--form" method="post" action="relax.jsp">
          <div class="flexsearch">
		<div class="flexsearch--wrapper">
			
				<div class="flexsearch--input-wrapper">
					<input class="flexsearch--input" type="search" name="search-name" placeholder="Search board name">
				</div>
...
<div class="headtext"><p>Create boards for movies, sports, music videos, and more.<br>Share these entertainment experiences with your friends and family, privately.</p></div>
        ...
        <div class="myboard">
            <div class="board-type">My leisure boards</div>
            <div class="board-add">
        ...
        <div id="my-boards-container">
                    ...
                    <%
                        ...
                        LeisureBoardList boards = new LeisureBoardList(sessionAccountNumber);
