...
<%@page import="object.board.posts.VideoObjectBoardPostList"%>
...
<%@page import="stream.VideoStream" %>
<%@page import="account.video.*" %>
<%@page import="video.peppers.VideoPepperToggleServlet" %>
<%@page import="video.board.posts.*" %>
      ...
      <%
                ...
                
                {
...

                    {
                        ...
                        VideoStream instantiator = new VideoStream();
                            ...
                            
                        {
                            ...
                            VideoRequestBoardPostCreate requestPostCreate = new VideoRequestBoardPostCreate(pageNumber, boardID, client.getClientID(), creationTime);
    ...
    { // IE < 9
        ...
        
        {
            ...
            <%
                    ...
                    VideoStream videos = new VideoStream(pageNumber);
        ...
        <div class=""></div>
            ...
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-logo-area">
                                    ...
                                    if (videos.getProgramDistributorPicture() != null) {

                                        %>
                        
                        <img id="distributor-logo" src="<%= videos.getProgramDistributorPicture() %>" alt="distributor-logo" />
                    ...
                    <div class="distributor-name-area">
                        ...
                        <div id="distributor-name">Distributed by <%= videos.getProgramDistributorName() %> | &COPY; <%= videos.getProducer() %>, <%= videos.getProductionCountry() %></div>
                    </div>
            ...
            <div class="lower-interactions">
                ...
                <div class="lower-interactions-right">
                    ...
                    <a class="clickable-text" href="javascript:submitVideoPepperSubmitForm();" title='Pep up this video.' >
                        <span id="number-of-peppers"><%= videos.getNumberOfPodcastPeppers() %> &nbsp; </span><i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pep</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayShareControls();" title='Post this video.' >
                        <span id="number-of-peppers"><%= videos.getNumberOfPodcastShares() %> &nbsp; </span><i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Share</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:feedToAccount(<%= pageNumber %>, <%= accountNumber %>);" title='Feed this video to your account.' >
                        <span id="number-of-peppers"><%= videos.getNumberOfPodcastFeeds() %> &nbsp; </span><i class="fa fa-home" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Feed</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayShareControls();" title='Pin this video.' >
                        <span id="number-of-peppers"><%= videos.getNumberOfPodcastShares() %> &nbsp; </span><i class="fa fa-thumb-tack" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pin to board</span>  &nbsp; &nbsp; 
                    </a>
                ...
                <div id="share-controls-div">
                        ...
                        <form id="share-form" name="share-form" method="post" action="../VideoBoardPostCreateServlet">
                            ...
                            <div class="share-top-left">
                                ...
                                <input type="text" id="request-video-id" name="request-video-id" value="<%= pageNumber %>" hidden />
            ...
            <div id="dashboard">
                ...
                <div id="dashboard-head"><div  id="dashboard-left">Dashboard</div><div id="dashboard-right">This board is for <%= board.getMemberType() %> of <%= board.getTeamName() %> only and is hosted by <%= hostClientName %>.</div></div>
                    ...
                    <div id="video-listing-area">
                        ...
                        for (int count = 0; (count < videos.length()) && (videos.getVideo(count) != null); count++)
                        ...
                        <div class="video-listing-container">
                            <a class="clickable-text" href="javascript:transferVideoByID(<%= videos.getVideo(count).getVideoID() %>);" >
                            <div>
            ...
            <%
                    ...
                    VideoObjectBoardPostList postList = new VideoObjectBoardPostList(boardID);
        ...
        %>
            ...
            if (postList.getObjectBoardPost(count) instanceof VideoBoardPost)
                
            {
       
                    VideoBoardPost videoPost = (VideoBoardPost) postList.getObjectBoardPost(count);
            ...
            <div id="share-post">
                    ...
                    <%
                                    ...
                                    if (videoPost.getClientProfilePicture() != null) {

                                        %>


                                    <img id="commenter-pic" src="<%= videoPost.getClientProfilePicture() %>" alt="picture" />
                                    ...
                                    {
                                        if (videoPost.getClientGender().equalsIgnoreCase("female")) {
                            ...
                            conversion = new DateLineConversion(videoPost.getCreationTime());

                                        %>
                            
                        </div>
                        <div id="share-post-header-right"><b><%= videoPost.getClientName() %></b> shared <b><%= videoPost.getVideoName() %></b>.</div>
                    
                    </div>
                    <div id="share-poster-background">
                        
                        <img id="share-poster-background-image" src="<%= videoPost.getThumbnail() %>" alt="poster"/>
                    
                    </div>
                    <div id="share-post-description"><%= videoPost.getMessage() %></div>
                    <div id="share-post-feedback-read"><%= conversion.getPostTimestamp() %></div>
                    <div id="share-post-feedback-write">
                    ...
                    <div class="share-post-feedback-write-area">
                            ...
                            <div id="post-like-button"><span id="video-board-post-peppers"><%= videoPost.getNumberOfPostPeppers() %></span> &nbsp; <a class="pep-link-design" href="javascript:registerVideoBoardPostPep(<%= client.getClientID() %>, <%= boardID %>, '<%= videoPost.getVideoID() %>', <%= videoPost.getClientID() %>, <%= videoPost.getCreationTime() %>);"><i class="fa fa-thumbs-up" style="font-size:16px;color:#f40"></i> &nbsp; <span>Pep</span></a></div>
        ...
        %>
            ...
            <%
                    ...
                    VideoRequestBoardPostList requestPostList = new VideoRequestBoardPostList(boardID);
        ...
        <div id="posts-left">
            ...
            for (count = 0; (count < requestPostList.length()) && (requestPostList.getVideoRequestBoardPost(count) != null); count++)
            ...
            <div id="stream-post">
                ...
                <div id="stream-post-header">
                    ...
                    <%
                                    ...
                                    if (requestPostList.getVideoRequestBoardPost(count).getClientProfilePicture() != null) {

                                        %>


                                    <img id="stream-request-commenter-pic" src="<%= requestPostList.getVideoRequestBoardPost(count).getClientProfilePicture() %>" alt="picture" />
                                    ...
                                    {
                                        if (requestPostList.getVideoRequestBoardPost(count).getClientGender().equalsIgnoreCase("female")) {
                        ...
                        <div id="stream-post-header-right"><%= requestPostList.getVideoRequestBoardPost(count).getClientName() %> requested:</div>
                        
                    </div>
                    <div id="stream-post-header-bottom"><b><%= requestPostList.getVideoRequestBoardPost(count).getVideoName() %></b></div>
                
                </div>
                <div id="stream-poster-background">
                    
                    <img id="stream-poster-background-image" src="<%= requestPostList.getVideoRequestBoardPost(count).getThumbnail() %>" alt="poster"/><br><br>
                            ...
                            conversion = new DateLineConversion(requestPostList.getVideoRequestBoardPost(count).getCreationTime());
                ...
                <div class="stream-post-feedback-write-area">
                        ...
                        <div id="stream-like-button"><span id="video-request-board-post-peppers"><%= requestPostList.getVideoRequestBoardPost(count).getNumberOfPostPeppers() %></span> &nbsp; <a class="pep-link-design" href="javascript:registerVideoRequestBoardPostPep(<%= client.getClientID() %>, <%= boardID %>, '<%= requestPostList.getVideoRequestBoardPost(count).getVideoID() %>', <%= requestPostList.getVideoRequestBoardPost(count).getClientID() %>, <%= requestPostList.getVideoRequestBoardPost(count).getCreationTime() %>);"><i class="fa fa-thumbs-up" style="font-size:16px;color:#f40"></i> &nbsp; <span>Pep</span></a></div>
...
function registerVideoBoardPostPep(pepperClientID, boardID, videoID, postClientID, postCreationTime)

{
    ...
    xml.onreadystatechange = function() {
            ...
            
        {
                ...
                
            {
                ...
                var numberOfPeppers = xml.responseXML.getElementsByTagName("peppers")[0].firstChild.nodeValue;
                document.getElementById("video-board-post-peppers").innerHTML = numberOfPeppers;
    ...
    xml.open("GET", "../VideoBoardPostPepperCreateServlet?" + post, true);
    xml.send();
    
    
}

function registerVideoRequestBoardPostPep(pepperClientID, boardID, videoID, postClientID, postCreationTime)

{
    ...
    xml.onreadystatechange = function() {
            ...
            
        {
                ...
                
            {
                ...
                var numberOfPeppers = xml.responseXML.getElementsByTagName("peppers")[0].firstChild.nodeValue;
                document.getElementById("video-request-board-post-peppers").innerHTML = numberOfPeppers;
    ...
    xml.open("GET", "../VideoRequestBoardPostPepperCreateServlet?" + post, true);
    xml.send();
