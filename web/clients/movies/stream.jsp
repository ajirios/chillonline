  ...
  <header>
      ...
      <div class="pre-subheader">
          ...
          <nav class="stream-navigation">
                ...
                <ul>
                    ...
                    <li><a class="a" href="../../clients/movies/stream.jsp" id="subpage" >Movies</a></li>
    ...
    <div class="store">
        ...
        <div class="checkout-processor">
            ...
            <div class="episodes">
                ...
                <span class="side-helper">
                    ...
                    <img id="podcast-side" src="<%= movies.getThumbnail() %>" alt="poster" />
                            
                </span>
                    </div>
                  <div class="title"><%= movies.getProgramName() %></div>
                  <div class="views"><%= movies.getProgramDistributorName() %></div>
                  <div class="views"><%= movies.getNumberOfPodcastFeeds() %> feeds</div>
        ...
        <div class="checkout-content">
            ...
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-name-area">
                        <div id="program-name"><%= movies.getProgramName() %></div>
            ...
            <div class="lower-interactions">
                ...
                <div class="lower-interactions-right">
                    ...
                    <a class="clickable-text" href="javascript:feedToAccount(<%= pageNumber %>, <%= accountNumber %>);" title='Feed this video to your account.' >
                        <span id="number-of-peppers"><%= movies.getNumberOfPodcastFeeds() %> &nbsp; </span><i class="fa fa-film" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Feed</span>  &nbsp; &nbsp; 
                    </a>
            ...
            <div id="program-description-area"><%= movies.getProgramDescription() %></div>
        ...
        <div class="checkout-information">
            ...
            <div class="checkout-poster">
                ...
                <img src="<%= movies.getProgramPoster() %>" alt='Cover poster' class="cover-poster" />
            ...
            <div class="cb-div">
                ...
                <form id="feed-form" name="feed-form" method="post" action="../../MovieFeed">
            ...
            <%
                        ...
                        for (count = 0; (count < 6) && (movies.getMovie(count) != null); count++) {
            ...
            <div class="checkout-poster">
                ...
                <a class="clickable-text" href="javascript:transferMovieByID(<%= movies.getMovie(count).getMovieID() %>);" ><div class="episode">
                  
                
                
                    <img src="<%= movies.getMovie(count).getMoviePoster() %>" alt='Cover poster' class="cover-poster" />
                
                
                
                  <div class="title"><%= movies.getMovie(count).getMovieName() %></div>
                  <div class="views"><%= movies.getMovie(count).getDistributor() %></div>
                  <div class="views"><%= movies.getMovie(count).getNumberOfPodcastFeeds() %> feeds</div>
                    </div>
                </a>
