        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="../../../clients/movies/documentary/carriers.jsp" class="current">&nbsp; Documentary</a></li>
        ...
        $('body').on('contextmenu', 'video', function(e) {return false;});
            ...
            <div class="carrier-container">
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="../../../movies/posters/highschoolmusical2.jpg" alt="poster"></div>
                    <div class="carrier-poster-info-container">
                        <div id="carrier-plan-container">The Ultimate Relaxation Movie Collection 2017</div>
