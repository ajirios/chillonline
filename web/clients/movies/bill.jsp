...
<body>
  ...
  <header>
    ...
    <form id="checkout_form" method="post" action="receipt.jsp">
    ...
    { 
        ...
        <div class="bill">
            ...
            <div class="proceed-area">
                    ...
                    <br>
                    <div class="rst"><div class="toll">By clicking on the button below, I hereby agree that this package will be added to the specified account(s) 
                    ...
                    <button class="checkout-button" onclick="transferMovieByID(<%= bill.getArticleID() %>, 'purchase')">Post to My Account</button><br><br>
                        ...
                        <%
                            ...
                            else if (transaction.equalsIgnoreCase("rental")) {
                            
                            %>
                        
                    
                    <button class="checkout-button" onclick="transferMovieByID(<%= bill.getArticleID() %>, 'rental')">Post to My Account</button><br><br>
