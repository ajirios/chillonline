<%-- 
    Document   : index
    Created on : 15-Oct-2016, 7:58:38 PM
    Author     : El Jefe
--%>
    ...
    <script>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../../clients/channels/index.jsp" >&nbsp; TV channels</a></li>
                    <li><a href="../../clients/sounds/index.jsp" >&nbsp; Radio channels</a></li>
                    <li><a href="../../clients/games/index.jsp" class="current" >&nbsp; Games</a></li>
                </ul>
        ...
        <div class="browsed">    
            ...
            <%
                    ...
                    GameList games = new GameList(pageNumber);
            ...
            <div hidden id="page-request-form-div">
                ...
                <form id="page-request-form" method="post" action="index.jsp">
                    ...
                    <input type="text" id="final-page-number" name="final-page-number" value="<%= games.getFinalPageNumber() %>" />
                    ...
                    <%
                        ...
                        for (count = 0; (count < 18) && (games.getGame(count) != null); count++) {
                        %>
            ...
            <div class="product">
                ...
                <div class="commentaries"><a class="definition-style"><%= games.getGame(count).getPurchasePrice() %></a></div>
                    ...
                    <div class="hottest"><div class="browsing">
                            ...
                            <div class="browsing-place"><%= games.getCurrentPageNumber() %> of <%= games.getFinalPageNumber() %></div>
