<%-- 
    Document   : carriers
    Created on : 20-Feb-2017, 3:52:33 PM
    Author     : El Jefe
--%>
  ...
  <header>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../../clients/games/carriers.jsp" class="current">&nbsp; Games</a></li>
                </ul>
    ...
    <%
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="../../games/posters/pepperpanic.jpg" alt="poster"></div>
                    <div class="carrier-poster-info-container">
                        <div id="carrier-plan-container">The Ultimate Game Collection 2017</div>
                ...
                <div class="plan-container">
                    ...
                    <%
                            ...
                            <div id="view-all">
                                <div class="carrier-toll"><span class="carrier-toll-fee">USD$56.50</span><span class="carrier-toll-month"> / mo.</span></div>
