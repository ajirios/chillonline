<%-- 
    Document   : earn
    Created on : 12-Oct-2017, 3:51:22 AM
    Author     : El Jefe
--%>
...
<body>
  ...
  <header>
      ...
      <div class="head">
        ...
        <div class="headtext"><p>Earn 35% to bring in people and organize your own social network.</p></div>
        ...
        <div id="container">
            ...
            <div class="class-area">
                ...
                <div><h3>Enter a team identification disclaimer.</h3></div>
                ...
                <input required type="radio" id="class1" name="class" value="1"> &nbsp; &nbsp; <label for='class1'>Class 1 (maximum 6 members) &nbsp; &nbsp; &nbsp; &nbsp; </label><br><br>
