<%-- 
    Document   : music
    Created on : 17-Sep-2016, 2:07:28 AM
    Author     : El Jefe
--%>
...
<%@page import="object.board.posts.SongObjectBoardPostList"%>
<%@page import="java.text.SimpleDateFormat"%>
<%@page import="board.BoardRetrieve"%>
<%@page import="java.sql.*" %>
<%@page import="board.stream.SongStream" %>
<%@page import="account.music.*" %>
<%@page import="song.peppers.*" %>
<%@page import="song.board.posts.*" %>
...
<script type="text/javascript">
    ...
    <%
        ...
        %>
                ...
                <form hidden id="board-id-request-form" method="post" action="music.jsp">
      ...
      <%
                ...
                
                {
...

                    {
                        ...
                        SongStream instantiator = new SongStream();
                            ...
                            
                        {
                            ...
                            SongRequestBoardPostCreate requestPostCreate = new SongRequestBoardPostCreate(pageNumber, boardID, client.getClientID(), creationTime);
            ...
            <%
                    ...
                    SongStream song = new SongStream(pageNumber);
                ...
                <div id="page-request-form-div" hidden>
                    ...
                    <form id="page-request-form" method="post" action="music.jsp" hidden>
                ...
                <form id="video-pepper-submit-form" method="post" action="../SongPepperToggleServlet" hidden>
                    
                    <input type="text" id="music-pepper-id" name="music-pepper-id" value="<%= song.getMusicID() %>" />
                    <input type="text" id="song-pepper-id" name="song-pepper-id" value="<%= pageNumber %>" />
                    <input type="text" id="music-pepper-account-number" name="music-pepper-account-number" value="<%= accountNumber %>" />
                    <input type="text" id="music-pepper-return-page" name="music-pepper-return-page" value="clients/music.jsp" />
                    <input type="submit" />
                ...
                <form id="feed-form" name="feed-form" method="post" target="_parent" action="../MusicFeed" hidden>
                    <input type="text" id="program-request-number" name="program-request-number" value="<%= song.getMusicID() %>" hidden />
                    <input type="text" id="account-request-number" name="account-request-number" value="<%= accountNumber %>" hidden />
                    <input type="text" id="song-request-number" name="song-request-number" value="<%= pageNumber %>" hidden />
                    <input type="text" id="program-request-department" name="program-request-department" value="music" hidden />
    ...
    { // IE < 9
        ...
        <div class=""></div>
            <div class="blackscreen">
                    ...
                    <div id="big-headphones-division">
                        <i class="fa fa-music" style="font-size:255px;color:#ccc"></i>
                    </div>
                
                    
                    
                    <audio id="music-podcast" autoplay>
                        <source src="<%= song.getPodcast() %>" type="audio/mpeg">
            ...
            <div class="upper-interactions">
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-logo-area">
                                    ...
                                    if (song.getDistributorPicture() != null) {

                                        %>
                        
                        <img id="distributor-logo" src="<%= song.getDistributorPicture() %>" alt="distributor-logo" />
                    ...
                    <div class="distributor-name-area">
                        <div id="program-name"><%= song.getSongName() %></div>
                        <div id="distributor-name">Distributed by <%= song.getDistributorName() %> | &COPY; <%= song.getProducer() %>, <%= song.getProductionCountry() %></div>
                    </div>
            ...
            <div class="lower-interactions">
                ...
                <div class="lower-interactions-right">
                    ...
                    <a class="clickable-text" href="javascript:submitMoviePepperSubmitForm();" title='Pep up this video.' >
                        <span id="number-of-peppers"><%= song.getNumberOfPodcastPeppers() %> &nbsp; </span><i class="fa fa-thumbs-up" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pep</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayShareControls();" title='Post this video.' >
                        <span id="number-of-peppers"><%= song.getNumberOfPodcastShares() %> &nbsp; </span><i class="fa fa-share" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Share</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:feedToAccount(<%= pageNumber %>, <%= accountNumber %>);" title='Feed this video to your account.' >
                        <span id="number-of-peppers"><%= song.getNumberOfPodcastFeeds() %> &nbsp; </span><i class="fa fa-home" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Feed</span>  &nbsp; &nbsp; 
                    </a>
                    <a class="clickable-text" href="javascript:displayShareControls();" title='Pin this video.' >
                        <span id="number-of-peppers"><%= song.getNumberOfPodcastShares() %> &nbsp; </span><i class="fa fa-thumb-tack" style="font-size:15px;color:orangered"></i> &nbsp; <span id="number-of-peppers">Pin to board</span>  &nbsp; &nbsp; 
                    </a>
                ...
                <div id="share-controls-div">
                        ...
                        <form id="share-form" name="share-form" method="post" action="../SongBoardPostCreateServlet">
                            ...
                            <div class="share-top-left">
                                ...
                                <input type="text" id="request-song-id" name="request-song-id" value="<%= pageNumber %>" hidden />
            ...
            <%
                    ...
                    SongObjectBoardPostList postList = new SongObjectBoardPostList(boardID);
        ...
        %>
            ...
            if (postList.getObjectBoardPost(count) instanceof SongBoardPost)
                
            {
       
                    SongBoardPost songPost = (SongBoardPost) postList.getObjectBoardPost(count);
            ...
            <div id="share-post">
                    ...
                    <%
                                    ...
                                    if (songPost.getClientProfilePicture() != null) {

                                        %>


                                    <img id="commenter-pic" src="<%= songPost.getClientProfilePicture() %>" alt="picture" />
                                    ...
                                    {
                                        if (songPost.getClientGender().equalsIgnoreCase("female")) {
                            ...
                            conversion = new DateLineConversion(songPost.getCreationTime());

                                        %>
                            
                        </div>
                        <div id="share-post-header-right"><b><%= songPost.getClientName() %></b> shared <b><%= songPost.getSongName() %></b>.</div>
                    
                    </div>
                    <div id="share-poster-background">
                        
                        <img id="share-poster-background-image" src="<%= songPost.getMusicPoster() %>" alt="poster"/>
                    
                    </div>
                    <div id="share-post-description"><%= songPost.getMessage() %></div>
                    <div id="share-post-feedback-read"><%= conversion.getPostTimestamp() %></div>
                    <div id="share-post-feedback-write">
                    ...
                    <div class="share-post-feedback-write-area">
                            ...
                            <div id="post-like-button"><span id="song-board-post-peppers"><%= songPost.getNumberOfPostPeppers() %></span> &nbsp; <a class="pep-link-design" href="javascript:registerSongBoardPostPep(<%= client.getClientID() %>, <%= boardID %>, '<%= songPost.getSongID() %>', <%= songPost.getClientID() %>, <%= songPost.getCreationTime() %>);"><i class="fa fa-thumbs-up" style="font-size:16px;color:#f40"></i> &nbsp; <span>Pep</span></a></div>
        ...
        %>
            ...
            <%
                    ...
                    SongRequestBoardPostList requestPostList = new SongRequestBoardPostList(boardID);
        ...
        <div id="posts-left">
            ...
            for (count = 0; (count < requestPostList.length()) && (requestPostList.getSongRequestBoardPost(count) != null); count++)
            ...
            <div id="stream-post">
                ...
                <div id="stream-post-header">
                    ...
                    <%
                                    ...
                                    if (requestPostList.getSongRequestBoardPost(count).getClientProfilePicture() != null) {

                                        %>


                                    <img id="stream-request-commenter-pic" src="<%= requestPostList.getSongRequestBoardPost(count).getClientProfilePicture() %>" alt="picture" />
                                    ...
                                    {
                                        if (requestPostList.getSongRequestBoardPost(count).getClientGender().equalsIgnoreCase("female")) {
                            ...
                            conversion = new DateLineConversion(requestPostList.getSongRequestBoardPost(count).getCreationTime());
                        ...
                        <div id="stream-post-header-right"><%= requestPostList.getSongRequestBoardPost(count).getClientName() %> requested:</div>
                        
                    </div>
                    <div id="stream-post-header-bottom"><b><%= requestPostList.getSongRequestBoardPost(count).getSongName() %></b></div>
                
                </div>
                <div id="stream-poster-background">
                    
                    <img id="stream-poster-background-image" src="<%= requestPostList.getSongRequestBoardPost(count).getMusicPoster() %>" alt="poster"/><br><br>
                ...
                <div class="stream-post-feedback-write-area">
                        ...
                        <div id="stream-like-button"><span id="song-request-board-post-peppers"><%= requestPostList.getSongRequestBoardPost(count).getNumberOfPostPeppers() %></span> &nbsp; <a class="pep-link-design" href="javascript:registerSongRequestBoardPostPep(<%= client.getClientID() %>, <%= boardID %>, '<%= requestPostList.getSongRequestBoardPost(count).getSongID() %>', <%= requestPostList.getSongRequestBoardPost(count).getClientID() %>, <%= requestPostList.getSongRequestBoardPost(count).getCreationTime() %>);"><i class="fa fa-thumbs-up" style="font-size:16px;color:#f40"></i> &nbsp; <span>Pep</span></a></div>
...
var myVideo = document.getElementById("music-podcast"); 
...
function registerSongBoardPostPep(pepperClientID, boardID, songID, postClientID, postCreationTime)

{
    ...
    xml.onreadystatechange = function() {
            ...
            
        {
                ...
                
            {
                ...
                var numberOfPeppers = xml.responseXML.getElementsByTagName("peppers")[0].firstChild.nodeValue;
                document.getElementById("song-board-post-peppers").innerHTML = numberOfPeppers;
    ...
    var post = "pepper-client-id=" + pepperClientID + "&post-client-id=" + postClientID + "&song-id=" + songID + "&board-id=" + boardID + "&post-creation-time=" + postCreationTime;
    
    xml.open("GET", "../SongBoardPostPepperCreateServlet?" + post, true);
    xml.send();
    
    
}

function registerSongRequestBoardPostPep(pepperClientID, boardID, songID, postClientID, postCreationTime)

{
    ...
    xml.onreadystatechange = function() {
            ...
            
        {
                ...
                
            {
                ...
                var numberOfPeppers = xml.responseXML.getElementsByTagName("peppers")[0].firstChild.nodeValue;
                document.getElementById("song-request-board-post-peppers").innerHTML = numberOfPeppers;
    ...
    xml.open("GET", "../SongRequestBoardPostPepperCreateServlet?" + post, true);
    xml.send();
