<%-- 
    Document   : profile
    Created on : 2-Sep-2017, 9:11:21 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Profile | Chillonline</title>
...
<body>
    ...
    <%
        ...
        if (request.getParameter("client-id") != null)
        ...
        ClientRetrieve client = new ClientRetrieve(clientID, "client");
...

{
    ...
    <div class="right">
        ...
        <div id="phonenumber"><h3>+1 (204) 951-9207</h3></div>
        <div id="connect">
    ...
    <div class="sept2">
        ...
        <div id="container">
            ...
            <div id="posts">
                ...
                <div class="connections-posts-label">Connections &nbsp; <i class="fa fa-user-plus" style="font-size:36px"></i><hr></div>
            ...
            <div id="program-description-area"><%= movies.getMovie((int) screenProgramID).getDescription() %></div>
                ...
                <div class="tvscreen">
                    ...
                    <video id="movieteaser-series" autoplay>
                            <source src="https://s3.ca-central-1.amazonaws.com/pegbucket/series/content/s2e9.mp4" type="video/mp4">
                            Your browser does not support HTML5 video.
                    </video>
                ...
                <div class="upper-interactions-left">
                    ...
                    <div class="distributor-logo-area"></div>
                    <div class="distributor-name-area">
                        <div id="program-name">Suite Life</div>
                        <div id="distributor-name">Disney Enterprises, Inc.</div>
                    </div>
            ...
            <div id="program-description-area"><%= videos.getVideo((int) screenProgramID).getDescription() %></div>
                ...
                <div class="tvscreen">
                    ...
                    <video id="movieteaser-music" autoplay>
                            <source src="https://s3.ca-central-1.amazonaws.com/pegbucket/series/content/s2e9.mp4" type="video/mp4">
                            Your browser does not support HTML5 video.
                    </video>
