<%-- 
    Document   : requests
    Created on : 2-Jul-2017, 11:43:24 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Requests | Chillonline</title>
...
<body>
    ...
    <%
        ...
        <%
            ...
            long accountNumber = Long.parseLong("545352566463667");
            long sessionAccountNumber = -1;
            ClientRetrieve sessionClient = null;
            
            
            if (request.getParameter("connection-request-id") != null)
                
            {
                accountNumber = Long.parseLong(request.getParameter("connection-request-id"));
...
{
    var myVideo = document.getElementById("movieteaser-video"); 
    myVideo.pause();
...

{
    ...
    function submitConnectionRequestAcceptForm()
    
    {
        document.forms["connection-request-accept-form"].submit(); 
    }
    
    function submitConnectionRequestDeclineForm()
    
    {
        document.forms["connection-request-decline-form"].submit(); 
    }
    ...
    <div class="right">
        ...
        <div id="connect">
            ...
            <button class="button2" onclick="submitConnectionRequestAcceptForm()">Accept</button>
            <button class="button2" onclick="submitConnectionRequestDeclineForm()">Decline</button>
    ...
    <div class="sept2">
        ...
        <div id="container">
            ...
            <div id="posts">
                ...
                <form hidden id="connection-request-accept-form" method="post" action="../ConnectionRequestAcceptServlet">
                    
                    <input type="text" id="connection-request-accept-account-number" name="connection-request-accept-account-number" value="<%= sessionAccountNumber %>" />
                    <input type="text" id="connection-request-accept-client-id" name="connection-request-accept-client-id" value="<%= client.getClientID() %>" />
                    <input type="text" id="connection-request-acceptee-account-number" name="connection-request-acceptee-account-number" value="<%= accountNumber %>" />
                    <input type="text" id="connection-request-acceptee-client-id" name="connection-request-acceptee-client-id" value="<%= sessionClient.getClientID() %>" />
                    <input type="submit" />
                    
                </form>
                
                
                <form hidden id="connection-request-decline-form" method="post" action="../ConnectionRequestDeclineServlet">
                    
                    <input type="text" id="connection-request-decline-account-number" name="connection-request-decline-account-number" value="<%= sessionAccountNumber %>" />
                    <input type="text" id="connection-request-decline-client-id" name="connection-request-decline-client-id" value="<%= client.getClientID() %>" />
                    <input type="submit" />
                ...
                <div class="connections-posts-label">Connections<hr></div>
