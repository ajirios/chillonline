<%-- 
    Document   : board-transcation-declined
    Created on : 11-Aug-2017, 11:46:18 AM
    Author     : El Jefe
--%>
...
<html>
<head>
<title>Board Transaction Declined | Chillonline</title>
    ...
    <%
        ...
        <div class="bill">
            ...
            <div class="proceed-area">
                ...
                <form method="post" action="../clients/account-billing.jsp" class="">
                
                    <div class=""></div><br><br><br>
                    
                    
                    <div class=""><i class="material-icons" style="font-size:90px;color:red;">cancel</i></div>
                    
                    <div><div>Oops! Unfortunately, your board was not added to your 
                            account. <br>
                            There is no valid credit card in your account. Please enter a valid credit card.</div></div><br><br>
                            <button class="checkout-button">Update Credit Card Information</button><br><br>
