<%-- 
    Document   : account-hold
    Created on : 31-Oct-2016, 2:46:41 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Freeze My Account | Chillonline</title>
        ...
        <div class="main-right">
            ...
            <%
                ...
                
                {
                    ...
                    {
                        freezeReason = "I am spending too much time on Chillonline.";
                    }

                    if (request.getParameter("reason").equals("2"))

                    {
                        freezeReason = "I am too addicted.";
                    }

                    if (request.getParameter("reason").equals("3"))

                    {
                        freezeReason = "Chillonline is currently reducing my self-esteem.";
                    }
                    
                    if (request.getParameter("reason").equals("4"))

                    {
                        freezeReason = "I want to spend more time on improving my career.";
                    }

                    if (request.getParameter("reason").equals("5"))

                    {
                        freezeReason = "I have an exam.";
                    }

                    if (request.getParameter("reason").equals("6"))

                    {
                        freezeReason = "I don't like the people I am connected to.";
                    }
                    
                    if (request.getParameter("reason").equals("7"))

                    {
                        freezeReason = "I need my information to be more private.";
                    }

                    if (request.getParameter("reason").equals("8"))

                    {
                        freezeReason = "I want to spend more time in the real world.";
                    }
                ...
                {
                    if (request.getParameter("duration").equals("1"))

                    {
                        freezeDuration = "More than a week.";
                    }

                    if (request.getParameter("duration").equals("2"))

                    {
                        freezeDuration = "More than a month.";
                    }

                    if (request.getParameter("duration").equals("3"))

                    {
                        freezeDuration = "More than three months.";
                    }
                    
                    if (request.getParameter("duration").equals("4"))

                    {
                        freezeDuration = "More than six months.";
                    }

                    if (request.getParameter("duration").equals("5"))

                    {
                        freezeDuration = "More than nine months.";
                    }
                    
                    if (request.getParameter("duration").equals("6"))

                    {
                        freezeDuration = "More than a year.";
                    }
                }
                ...
                AccountFreeze freeze = new AccountFreeze(clientID, freezeReason, freezeDuration, password);
