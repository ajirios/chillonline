<%-- 
    Document   : packages
    Created on : 29-May-2017, 11:05:31 AM
    Author     : El Jefe
--%>
...
<meta name="description" content="Rent multimedia packages containing movies, music, TV shows, TV channels, radio channels, and
      games, and share them with friends, family, and the world around you." />
          ...
          <a href=""><img class="bol" src="chillon.png" alt="bol"></a>
            ...
            <nav class="nav">
                ...
                <ul>  
                    ...
                    <li><a class="a" href="packages.jsp" id="page" >Packages</a></li>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="movies/documentary/packages.jsp" >&nbsp; Documentary</a></li>
            ...
            <div class="carrier-container">
                ...
                <%
                    ...
                    <%
                            ...
                            <div id="view-all">
                                <div class="carrier-toll"><span class="carrier-toll-fee">USD$19.50</span><span class="carrier-toll-month"> / mo.</span></div>
                                <div class="billing-period">*Billing periods are monthly. You can cancel anytime.</div>
                                <div class="carrier-subscribe"><button class="button-carrier">Subscribe to this carrier's monthly streaming package</button></div>
                            </div>
