...
<html lang="en"> 
<head>
<title>Game Packages | Chillonline</title>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../games/carriers.jsp" class="current" >&nbsp; Games</a></li>
                </ul>
        ...
        <div class="browsed">    
           ...
           <div class="carrier-container">
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="https://s3.ca-central-1.amazonaws.com/pegbucket/games/posters/pepperpanic.jpg" alt="poster"></div>
...
public Games()
{
    ...
    try
    {
        ...
        gamesStatement = gamesConnection.prepareStatement("SELECT gameID, gamePoster, gameName, distributor, purchasePrice, locality FROM games WHERE gameID<31");
    }
    ...
    return gameSet;
                ...
                <%
                    ...
                    <%
                        ...
                        for (count = 0; (count < 30) && (gamesSet.next() == true); count++) {
                        %>
                    
                        <div id="product-container2"><img class="program-poster2" src="<%= gamesSet.getString("gamePoster") %>" alt="poster"></div>
