<%-- 
    Document   : index
    Created on : 3-Sep-2016, 1:35:38 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Carrier Register | Chillonline</title>
    ...
    <div class="main">
        <div class="main-left">
            <div class="explanation">
                <span class="explanation-header">How The Carrier Account Works</span>
                <p>
                    When you register for a carrier account at Chillonline, you get to package content from other distributors and track the packages around the globe.
                    Content can be in any of four categories: videos, movies, series, music, games, channels, and sounds. You get to set a price whenever you make a post. The 
                    price must typically include how much you will get as a distributor, and how much we will get as the retailer. We will keep 80% of 
                    the income and remit the remaining 20% to you at the end of every month.
                </p>
            </div>
        </div>
        <div class="main-right">
            ...
            <form action="" method="post">
                <div class="titles">
                    ...
                    <p class="click-agreement">A carrier's password must be 8 - 12 characters in length with at least <br>one uppercase letter, one lowercase letter, and one special-case character.</p>
