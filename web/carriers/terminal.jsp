<%-- 
    Document   : terminal - departure and arrival area for views and a station for scheduling
    Created on : 16-Nov-2017, 7:11:34 PM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Terminal | Chillonline</title>
                ...
                <ul>
                    <li>
                        ...
                        <div id="my-account">
                            ...
                            <div class="action-container"><a class="action" href="../clients/home.jsp">Back to Client</a></div>
                            <div class="action-container"><a class="action" href="../distributors/uploads.jsp">My Distributions</a></div>
                            <div class="action-container"><a class="action" href="settings.jsp">My Account Settings</a></div>
                            <div class="action-container"><a class="action" href="info.jsp">My Account Info</a></div>
