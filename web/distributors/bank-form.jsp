<%-- 
    Document   : bank-form
    Created on : 5-Nov-2016, 12:17:08 AM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>Bank Form | Chillonline</title>
                ...
                <ul>
                    <li>
                        ...
                        <div id="my-account">
                            ...
                            <div class="action-container"><a class="action" href="home-form.jsp">My Account Home</a></div>
                            <div class="action-container"><a class="action" href="bank-form.jsp">My Account Banking</a></div>
                    ...
                    <li><a class="a" href="../distributors/posts.jsp" >Posts</a></li>
                    <li><a class="a" href="../distributors/home.jsp">Home</a></li>
                </ul>
    ...
    <div class="main">
        <div class="main-left">
            <div class="explanation">
                <span class="explanation-header">Distributor Information</span>
                <div>Representative Name*: <input type="text" class="names" id="first_name" placeholder="Representative Name"></div>
                <div>Business Name*: <input type="text" class="names" id="first_name" placeholder="Business Name"></div>
                <div>Business Address*: <input type="text" class="names" id="first_name" placeholder="Business Address"></div>
                <div>City*: <input type="text" class="names" id="first_name" placeholder="City"></div>
                <div>State or Province*: <input type="text" class="names" id="first_name" placeholder="State or Province"></div>
                <div>Country*: <input type="text" class="names" id="first_name" placeholder="Country"></div>
                <div>Postal or Zip Code: <input type="text" class="names" id="first_name" placeholder="Postal or Zip Code"></div>
                <div>Phone Number*: <input type="text" class="names" id="first_name" placeholder="Phone Number"></div>
                <div>Business Email Address*: <input type="text" class="names" id="first_name" placeholder="Email Address"></div>
                <br><br>
                <span class="explanation-header">Bank Account Information</span>
                <div>Bank Name*: <input type="text" class="names" id="first_name" placeholder="Bank Name"></div>
                <div>Bank Branch Address*: <input type="text" class="names" id="first_name" placeholder="Bank Branch Address"></div>
                <div>City*: <input type="text" class="names" id="first_name" placeholder="City"></div>
                <div>State or Province*: <input type="text" class="names" id="first_name" placeholder="State or Province"></div>
                <div>Postal or Zip Code: <input type="text" class="names" id="first_name" placeholder="Postal or Zip Code"></div>
                <div>Phone Number*: <input type="text" class="names" id="first_name" placeholder="Phone Number"></div>
                <div>Institution Number: <input type="text" class="names" id="first_name" placeholder="Institution Number"></div>
                <div>Branch Transit Number: <input type="text" class="names" id="first_name" placeholder="Branch Number"></div>
                <div>Account Number: <input type="text" class="names" id="first_name" placeholder="Account Number"></div>
                
                <button class="button2"><a href="bank-form.jsp" class="chillonline">Skip for Later</a></button>
                <button class="button2"><a href="bank-form.jsp" class="chillonline">Cancel</a></button>
                <button class="button2"><a href="bank-form.jsp" class="chillonline">Submit</a></button>
            </div>
        </div>
