...
<body>
  ...
  <header>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li><a href="../series/giveaways.jsp" class="current">&nbsp; Series</a></li>
    ...
    <form id="navigation-form" method="post" action="giveaways.jsp">
        
        <input type='number' id="page-number" name="page-number">
        <input type="submit" id="page-number-submit">
