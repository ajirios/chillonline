<%-- 
    Document   : carriers
    Created on : 30-Dec-2016, 12:34:35 AM
    Author     : El Jefe
--%>
...
<html lang="en"> 
<head>
<title>TV Series Packages | Chillonline</title>
...
<body>
  ...
  <header>
          ...
          <a href=""><img class="bol" src="../../chillon.png" alt="bol"></a>
            ...
            <nav class="nav">
                ...
                <ul>  
                    ...
                    <li><a class="a" href="../../public.jsp" >Store Giveaways</a></li>
                    <li><a class="a" href="../../index.jsp" >Store</a></li>
                    <li><a class="a" href="../../carriers.jsp" id="page">Packages</a></li>
                    <li><a class="a" href="../../stream.jsp" >Streaming</a></li>
    ...
    <div class="announcement">Find connections, create boards, and rent packages for individual and group enjoyment.
    ...
    <script>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    <li><a href="../../movies/carriers.jsp" >&nbsp; Movies</a></li>
                    <li class="genre"><a href="../../movies/kids/carriers.jsp" >&nbsp; Kids</a></li>
                    <li class="genre"><a href="../../movies/action/carriers.jsp" >&nbsp; Action</a></li>
                    <li class="genre"><a href="../../movies/comedy/carriers.jsp" >&nbsp; Comedy</a></li>
                    <li class="genre"><a href="../../movies/romance/carriers.jsp" >&nbsp; Romance</a></li>
                    <li class="genre"><a href="../../movies/horror/carriers.jsp" >&nbsp; Horror</a></li>
                    <li class="genre"><a href="../../movies/documentary/carriers.jsp" >&nbsp; Documentary</a></li>
                    <li class="genre"><a href="../../movies/adventure/carriers.jsp" >&nbsp; Adventure</a></li>
                    <li><a href="../../series/carriers.jsp" >&nbsp; Series</a></li>
                    <li class="genre"><a href="../../series/kids/carriers.jsp" >&nbsp; Kids</a></li>
                    <li class="genre"><a href="../../series/action/carriers.jsp" >&nbsp; Action</a></li>
                    <li class="genre"><a href="../../series/comedy/carriers.jsp" >&nbsp; Comedy</a></li>
                    <li class="genre"><a href="../../series/romance/carriers.jsp" class="current" >&nbsp; Romance</a></li>
                    <li class="genre"><a href="../../series/horror/carriers.jsp" >&nbsp; Horror</a></li>
                    <li class="genre"><a href="../../series/documentary/carriers.jsp" >&nbsp; Documentary</a></li>
                    <li class="genre"><a href="../../series/adventure/carriers.jsp" >&nbsp; Adventure</a></li>
                    <li><a href="../../videos/carriers.jsp" >&nbsp; Videos</a></li>
                    <li><a href="../../music/carriers.jsp" >&nbsp; Music</a></li>
                    <li><a href="../../channels/carriers.jsp" >&nbsp; TV channels</a></li>
                    <li><a href="../../sounds/carriers.jsp" >&nbsp; Radio channels</a></li>
                    <li><a href="../../games/carriers.jsp" >&nbsp; Games</a></li>
                </ul>
        ...
        <div class="browsed">    
            ...
            <div class="carrier-container">
                ...
                <div class="carrier-id-container">
                    ...
                    <div id="carrier-poster-container"><img class="program-poster" src="https://s3.ca-central-1.amazonaws.com/pegbucket/series/posters/birthofabeauty.jpg" alt="poster"></div>
                    <div class="carrier-poster-info-container">
                        <div id="carrier-plan-container">The Ultimate U.S. Series Collection 2017</div>
...
public Series()
{
    ...
    try
    {
        ...
        seriesStatement = seriesConnection.prepareStatement("SELECT seriesID, seriesPoster, seriesName, distributor, rentalPrice, locality FROM series WHERE seriesID<31");
    }
    ...
    return seriesSet;
                ...
                <%
                    ...
                    <%
                        ...
                        for (count = 0; (count < 30) && (seriesSet.next() == true); count++) {
                        %>
                    
                        <div id="product-container"><img class="program-poster" src="<%= seriesSet.getString("seriesPoster") %>" alt="poster"></div>
