          ...
          <a href=""><img class="bol" src="../../chillon.png" alt="bol"></a>
            ...
            <nav class="nav">
                ...
                <ul>  
                    ...
                    <li><a class="a" href="../../index.jsp" id="page">Packages</a></li>
        ...
        <div class="store-selector">
            ...
            <div class="dept-nav-place">
                ...
                <ul>
                    ...
                    <li class="genre"><a href="../../series/romance/carriers.jsp" >&nbsp; Romance</a></li>
                    <li class="genre"><a href="../../series/horror/carriers.jsp" class="current" >&nbsp; Horror</a></li>
