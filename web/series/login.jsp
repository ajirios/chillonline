...
<html lang="en"> 
<head>
    <title id="title">Chill Online | Series</title>
 ...
 ***********************/
.flexsearch {
  padding: 0 400px 0 400px; /* Padding for other horizontal elements */
}
.flexsearch--input {
...
<body>
  ...
  <header>
      ...
      <div class="head">
        ...
        <a href=""><img class="bol" src="../chillon.png" alt="bol"></a>
            ...
            <nav>
                ...
                <ul>
                    <li><a href="../index.jsp" >Portal</a></li>
                    <li><a href="../music/login.jsp" >Sounds</a></li>
                    <li><a href="../games/login.jsp">Games</a></li>
                    <li><a href="../videos/login.jsp" >Videos</a></li>
                    <li><a href="../movies/login.jsp" >Movies</a></li>
                    <li><a href="../series/login.jsp" class="current">Series</a></li>
    ...
    <div class="subheader">
        ...
        <div class="feed"><a href="" class="white"><b>Client</b></a></div>
        <div class="feed"><a href="" class="white"><b>Crew</b></a></div>
        <div class="feed"><a href="" class="white"><b>Feed</b></a></div>
      ...
      <div class="flexsearch">
        ...
        <div class="feed"><a href="" class="white"><b>Boarding</b></a></div>
        <div class="feed"><a href="" class="white"><b>Shipping</b></a></div>
        <div class="feed"><a href="" class="white"><b>Settings &nbsp; </b></a></div>
