 ...
 * @author El Jefe
 */
public class PhotoBoardPostComment 

{
    ...
    public PhotoBoardPostComment(String photoID, long boardID, long postClientID, long commentClientID, String postCreationTime, String commentCreationTime, String message)
