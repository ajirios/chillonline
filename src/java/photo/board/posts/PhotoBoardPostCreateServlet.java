 ...
 * @author El Jefe
 */
@WebServlet(name = "PhotoBoardPostCreateServlet", urlPatterns = {"/PhotoBoardPostCreateServlet"})
public class PhotoBoardPostCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PhotoBoardPostCreateServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PhotoBoardPostCreateServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    {
        PhotoBoardPostCreate postCreate = null;
        String photoID = null;
        long boardID = -1;
        long clientID = -1;
            ...
            
        {
                ...
                
            {
                ...
                uploadedFile = "https://s3.ca-central-1.amazonaws.com/pegbucket/boards/photos/" + fileName;
        ...
        if ((photoID != null) && (boardID != -1) && (clientID != -1))
            
        {
            postCreate = new PhotoBoardPostCreate(photoID, boardID, clientID, creationTime, message);
        }
