 ...
 * @author El Jefe
 */
@WebServlet(name = "BoardInvitationAcceptServlet", urlPatterns = {"/BoardInvitationAcceptServlet"})
public class BoardInvitationAcceptServlet extends HttpServlet 

{
    ...
    
    {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BoardInvitationAcceptServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BoardInvitationAcceptServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    
    {
        ...
        if (request.getParameter("board-invitation-accept-account-number") != null)
            
        {
            accountNumber = Long.parseLong(request.getParameter("board-invitation-accept-account-number"));
        }
        
        if (request.getParameter("board-invitation-accept-board-id") != null)
            
        {
            boardID = Long.parseLong(request.getParameter("board-invitation-accept-board-id"));
        }
