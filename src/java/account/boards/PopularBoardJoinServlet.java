 ...
 * @author El Jefe
 */
@WebServlet(name = "PopularBoardJoinServlet", urlPatterns = {"/PopularBoardJoinServlet"})
public class PopularBoardJoinServlet extends HttpServlet 

{
    ...
    
    {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PopularBoardJoinServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PopularBoardJoinServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    
    {
        ...
        if (request.getParameter("popular-board-join-account-number") != null)
            
        {
            accountNumber = Long.parseLong(request.getParameter("popular-board-join-account-number"));
        }
        
        if (request.getParameter("popular-board-join-board-id") != null)
            
        {
            boardID = Long.parseLong(request.getParameter("popular-board-join-board-id"));
        }
