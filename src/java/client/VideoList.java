...

{
    ...
    public VideoList()
    {
        ...
        try
        {
            ...
            videosStatement = videosConnection.prepareStatement("SELECT videoID, videoPoster, videoName, distributor, purchasePrice, locality FROM videos WHERE videoID<" + this.size);
        }
    ...
    public VideoList(int pageNumber)
    {
        ...
        {
            videosConnection = DriverManager.getConnection(URL, userName, password);
            videosStatement = videosConnection.prepareStatement("SELECT videoID, videoPoster, videoName, distributor, purchasePrice, locality FROM videos "
            ...
            
    {
            ...
            
        {
...

            {
                ...
                videos[count] = new Video(nextCount, videosSet.getString("videoName"), videosSet.getString("videoPoster"), videosSet.getString("distributor"), videosSet.getString("purchasePrice"), videosSet.getString("locality"));
