 ...
 * @author El Jefe
 */
@WebServlet(name = "EpisodeRequestBoardPostPepperCreateServlet", urlPatterns = {"/EpisodeRequestBoardPostPepperCreateServlet"})
public class EpisodeRequestBoardPostPepperCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        EpisodeRequestBoardPostPepperCreate pepperCreate = null;
        EpisodeRequestBoardPostPepperList pepperList = null;
        EpisodeRequestBoardPostUpdate postUpdate = null;
            ...
            
        {
            ...
            pepperCreate = new EpisodeRequestBoardPostPepperCreate(episodeID, boardID, postClientID, pepperClientID, postCreationTime);
            pepperList = new EpisodeRequestBoardPostPepperList(episodeID, boardID, postClientID, Long.parseLong(postCreationTime));
            long numberOfPeppers = Long.valueOf(pepperList.getSize());
            postUpdate = new EpisodeRequestBoardPostUpdate(episodeID, boardID, postClientID, postCreationTime);
