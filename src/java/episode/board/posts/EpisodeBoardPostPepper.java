 ...
 * @author El Jefe
 */
public class EpisodeBoardPostPepper 

{
    ...
    public EpisodeBoardPostPepper(String episodeID, long boardID, long postClientID, long pepperClientID, String postCreationTime)
