 ...
 * @author El Jefe
 */
public class EpisodeRequestBoardPostPepper 

{
    ...
    public EpisodeRequestBoardPostPepper(String episodeID, long boardID, long postClientID, long pepperClientID, String postCreationTime)
