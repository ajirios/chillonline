 ...
 * @author El Jefe
 */
@WebServlet(name = "NoticeBoardPostCommentCreateServlet", urlPatterns = {"/NoticeBoardPostCommentCreateServlet"})
public class NoticeBoardPostCommentCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        NoticeBoardPostCommentCreate commentCreate = null;
        NoticeBoardPostCommentList commentList = null;
            ...
            
        {
            ...
            commentCreate = new NoticeBoardPostCommentCreate(boardID, postClientID, commentClientID, postCreationTime, commentCreationTime, message);
            commentList = new NoticeBoardPostCommentList(boardID, postClientID, Long.parseLong(postCreationTime));
