 ...
 * @author El Jefe
 */
public class NoticeBoardPostComment 

{
    ...
    public NoticeBoardPostComment(long boardID, long postClientID, long commentClientID, String postCreationTime, String commentCreationTime, String message)
