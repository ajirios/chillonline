...

{
  ...
  /*  @Override
    ...
    
    {
        ...
        if (password.equals(account.getPassword()) && (account.getAccountType().equalsIgnoreCase("client")) && (accountNumber != null))
    ...
    
    {
            ...
            
        {
            ...
            {
                AccountRetrieve account = new AccountRetrieve(email, password);
