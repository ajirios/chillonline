 ...
 * @author El Jefe
 */
@WebServlet(name = "TutorialBoardPostPepperCreateServlet", urlPatterns = {"/TutorialBoardPostPepperCreateServlet"})
public class TutorialBoardPostPepperCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        
        {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TutorialBoardPostPepperCreateServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TutorialBoardPostPepperCreateServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    
    {
        ...
        TutorialBoardPostPepperCreate pepperCreate = null;
        TutorialBoardPostPepperList pepperList = null;
            ...
            
        {
            ...
            pepperCreate = new TutorialBoardPostPepperCreate(videoID, boardID, postClientID, pepperClientID, postCreationTime);
            pepperList = new TutorialBoardPostPepperList(videoID, boardID, postClientID, Long.parseLong(postCreationTime));
