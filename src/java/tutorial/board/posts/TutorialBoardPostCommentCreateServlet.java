 ...
 * @author El Jefe
 */
@WebServlet(name = "TutorialBoardPostCommentCreateServlet", urlPatterns = {"/TutorialBoardPostCommentCreateServlet"})
public class TutorialBoardPostCommentCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        
        {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TutorialBoardPostCommentCreateServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet TutorialBoardPostCommentCreateServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    
    {
        ...
        TutorialBoardPostCommentCreate commentCreate = null;
        TutorialBoardPostCommentList commentList = null;
        TutorialBoardPostUpdate postUpdate = null;
        ...
        if ((commentClientID != -1) && (postClientID != -1) && (boardID != -1) && (videoID != null) && (postCreationTime != null))
            
        {
            
            commentCreate = new TutorialBoardPostCommentCreate(videoID, boardID, postClientID, commentClientID, postCreationTime, commentCreationTime, message);
            commentList = new TutorialBoardPostCommentList(videoID, boardID, postClientID, Long.parseLong(postCreationTime));
            long numberOfComments = Long.valueOf(commentList.getSize());
            postUpdate = new TutorialBoardPostUpdate(videoID, boardID, postClientID, postCreationTime);
