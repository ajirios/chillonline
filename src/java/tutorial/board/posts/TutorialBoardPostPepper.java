 ...
 * @author El Jefe
 */
public class TutorialBoardPostPepper 

{
    ...
    public TutorialBoardPostPepper(String videoID, long boardID, long postClientID, long pepperClientID, String postCreationTime)
