 ...
 * @author El Jefe
 */
@WebServlet(name = "MovieBoardPostPepperCreateServlet", urlPatterns = {"/MovieBoardPostPepperCreateServlet"})
public class MovieBoardPostPepperCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        MovieBoardPostPepperCreate pepperCreate = null;
        MovieBoardPostPepperList pepperList = null;
        MovieBoardPostUpdate postUpdate = null;
            ...
            
        {
            ...
            pepperCreate = new MovieBoardPostPepperCreate(movieID, boardID, postClientID, pepperClientID, postCreationTime);
            pepperList = new MovieBoardPostPepperList(movieID, boardID, postClientID, Long.parseLong(postCreationTime));
            long numberOfPeppers = Long.valueOf(pepperList.getSize());
            postUpdate = new MovieBoardPostUpdate(movieID, boardID, postClientID, postCreationTime);
