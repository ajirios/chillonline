 ...
 * @author El Jefe
 */
public class MovieBoardPostComment 

{
    ...
    public MovieBoardPostComment(String movieID, long boardID, long postClientID, long commentClientID, String postCreationTime, String commentCreationTime, String message)
