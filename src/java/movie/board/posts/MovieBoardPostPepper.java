 ...
 * @author El Jefe
 */
public class MovieBoardPostPepper 

{
    ...
    public MovieBoardPostPepper(String movieID, long boardID, long postClientID, long pepperClientID, String postCreationTime)
