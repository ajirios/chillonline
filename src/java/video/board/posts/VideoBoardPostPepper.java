 ...
 * @author El Jefe
 */
public class VideoBoardPostPepper 

{
    ...
    public VideoBoardPostPepper(String videoID, long boardID, long postClientID, long pepperClientID, String postCreationTime)
