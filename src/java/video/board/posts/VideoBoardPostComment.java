 ...
 * @author El Jefe
 */
public class VideoBoardPostComment 

{
    ...
    public VideoBoardPostComment(String videoID, long boardID, long postClientID, long commentClientID, String postCreationTime, String commentCreationTime, String message)
