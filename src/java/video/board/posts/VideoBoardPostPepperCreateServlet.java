 ...
 * @author El Jefe
 */
@WebServlet(name = "VideoBoardPostPepperCreateServlet", urlPatterns = {"/VideoBoardPostPepperCreateServlet"})
public class VideoBoardPostPepperCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        VideoBoardPostPepperCreate pepperCreate = null;
        VideoBoardPostPepperList pepperList = null;
        VideoBoardPostUpdate postUpdate = null;
            ...
            
        {
            ...
            pepperCreate = new VideoBoardPostPepperCreate(videoID, boardID, postClientID, pepperClientID, postCreationTime);
            pepperList = new VideoBoardPostPepperList(videoID, boardID, postClientID, Long.parseLong(postCreationTime));
            long numberOfPeppers = Long.valueOf(pepperList.getSize());
            postUpdate = new VideoBoardPostUpdate(videoID, boardID, postClientID, postCreationTime);
