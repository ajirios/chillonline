 ...
 * @author El Jefe
 */
public class VideoRequestBoardPostPepper 

{
    ...
    public VideoRequestBoardPostPepper(String videoID, long boardID, long postClientID, long pepperClientID, String postCreationTime)
