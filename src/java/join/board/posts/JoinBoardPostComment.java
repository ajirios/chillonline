 ...
 * @author El Jefe
 */
public class JoinBoardPostComment 

{
    ...
    public JoinBoardPostComment(long boardID, long postClientID, long commentClientID, String postCreationTime, String commentCreationTime, String message)
