 ...
 * @author El Jefe
 */
@WebServlet(name = "JoinBoardPostPepperCreateServlet", urlPatterns = {"/JoinBoardPostPepperCreateServlet"})
public class JoinBoardPostPepperCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        JoinBoardPostPepperCreate pepperCreate = null;
        JoinBoardPostPepperList pepperList = null;
            ...
            
        {
            ...
            pepperCreate = new JoinBoardPostPepperCreate(boardID, postClientID, pepperClientID, postCreationTime);
            pepperList = new JoinBoardPostPepperList(boardID, postClientID, Long.parseLong(postCreationTime));
