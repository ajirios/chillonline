 ...
 * @author El Jefe
 */
@WebServlet(name = "DocumentBoardPostCommentCreateServlet", urlPatterns = {"/DocumentBoardPostCommentCreateServlet"})
public class DocumentBoardPostCommentCreateServlet extends HttpServlet 

{
    ...
    
    {
        ...
        
        {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DocumentBoardPostCommentCreateServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DocumentBoardPostCommentCreateServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    
    {
        ...
        DocumentBoardPostCommentCreate commentCreate = null;
        DocumentBoardPostCommentList commentList = null;
        ...
        if ((commentClientID != -1) && (postClientID != -1) && (boardID != -1) && (documentID != null) && (postCreationTime != null))
            
        {
            
            commentCreate = new DocumentBoardPostCommentCreate(documentID, boardID, postClientID, commentClientID, postCreationTime, commentCreationTime, message);
            commentList = new DocumentBoardPostCommentList(documentID, boardID, postClientID, Long.parseLong(postCreationTime));
