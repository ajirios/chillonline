 ...
 * @author El Jefe
 */
@WebServlet(name = "PublicityBoardUpdateServlet", urlPatterns = {"/PublicityBoardUpdateServlet"})
public class PublicityBoardUpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PublicityBoardUpdateServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PublicityBoardUpdateServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    
    {
        ...
        if ((boardID != -1) && (reservationMode != null))
            
        {
            
            update = new BoardUpdate(boardID);
            update.setPublicityMode(reservationMode);
