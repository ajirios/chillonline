...
import song.board.posts.SongBoardPostList;

/**
 *
 * @author El Jefe
 */
public class SongObjectBoardPostList 

{
    ...
    private SongBoardPostList songPostList;
    
    public SongObjectBoardPostList(long boardID)
            
    {
        ...
        this.songPostList = new SongBoardPostList(boardID);
            ...
            
    {
        ...
        for (count = start; innerCount < this.songPostList.getSize(); count++)
            
        {
            
            this.objects[count] = this.songPostList.getSongBoardPost(innerCount);
            this.times[count] = this.songPostList.getSongBoardPost(innerCount).getLongitudinalCreationDate();
            innerCount++;
            ...
            
    {
        ...
        count = documentPostList.getSize() + photoPostList.getSize() + noticePostList.getSize() + joinPostList.getSize() + songPostList.getSize();
