...
import episode.board.posts.EpisodeBoardPostList;
 ...
 * @author El Jefe
 */
public class EpisodeObjectBoardPostList 

{
    ...
    private EpisodeBoardPostList episodePostList;
    
    public EpisodeObjectBoardPostList(long boardID)
            
    {
        ...
        this.episodePostList = new EpisodeBoardPostList(boardID);
            ...
            
    {
        ...
        for (count = start; innerCount < this.episodePostList.getSize(); count++)
            
        {
            
            this.objects[count] = this.episodePostList.getEpisodeBoardPost(innerCount);
            this.times[count] = this.episodePostList.getEpisodeBoardPost(innerCount).getLongitudinalCreationDate();
            innerCount++;
            ...
            
    {
        ...
        count = documentPostList.getSize() + photoPostList.getSize() + noticePostList.getSize() + joinPostList.getSize() + episodePostList.getSize();
