...
import movie.board.posts.MovieBoardPostList;
 ...
 * @author El Jefe
 */
public class MovieObjectBoardPostList 

{
    ...
    private MovieBoardPostList moviePostList;
    
    public MovieObjectBoardPostList(long boardID)
            
    {
        ...
        this.moviePostList = new MovieBoardPostList(boardID);
            ...
            
    {
        ...
        for (count = start; innerCount < this.moviePostList.getSize(); count++)
            
        {
            
            this.objects[count] = this.moviePostList.getMovieBoardPost(innerCount);
            this.times[count] = this.moviePostList.getMovieBoardPost(innerCount).getLongitudinalCreationDate();
            innerCount++;
            ...
            
    {
        ...
        count = documentPostList.getSize() + photoPostList.getSize() + noticePostList.getSize() + joinPostList.getSize() + moviePostList.getSize();
