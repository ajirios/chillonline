...
import tutorial.board.posts.TutorialBoardPostList;

/**
 *
 * @author El Jefe
 */
public class TutorialObjectBoardPostList 

{
    ...
    private TutorialBoardPostList tutorialPostList;
    
    public TutorialObjectBoardPostList(long boardID)
            
    {
        ...
        this.tutorialPostList = new TutorialBoardPostList(boardID);
        
        this.size = getObjectBoardPostCount();
        this.objects = new Object[this.size];
        this.times = new long[this.size];
        
        System.out.println("TutorialObjectBoardPostList is size " + this.size);
            ...
            
    {
        ...
        for (count = start; innerCount < this.tutorialPostList.getSize(); count++)
            
        {
            
            this.objects[count] = this.tutorialPostList.getTutorialBoardPost(innerCount);
            this.times[count] = this.tutorialPostList.getTutorialBoardPost(innerCount).getLongitudinalCreationDate();
            innerCount++;
            ...
            
    {
        ...
        count = documentPostList.getSize() + photoPostList.getSize() + noticePostList.getSize() + joinPostList.getSize() + tutorialPostList.getSize();
