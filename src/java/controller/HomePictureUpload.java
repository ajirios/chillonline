 ...
 * @author El Jefe
 */
@WebServlet(name = "HomePictureUpload", urlPatterns = {"/HomePictureUpload"})
public class HomePictureUpload extends HttpServlet 

{
    ...
    
    {
        ...
        
        {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HomePictureUpload</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HomePictureUpload at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    
    {
            ...
            
        {
                ...
                
            {
                ...
                directoryName = "clients/pictures/" + fileName;
                
                if (accountNumber != -1)

                {
                    s3Client.uploadfile(credentials, bucketName, directoryName, fileIS, metadata);
                    uploadedPicture = "https://s3.ca-central-1.amazonaws.com/pegbucket/clients/pictures/" + fileName;
